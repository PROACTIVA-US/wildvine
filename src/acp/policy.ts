...
export function isAcpEnabledByPolicy(cfg: WildvineConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: WildvineConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: WildvineConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: WildvineConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: WildvineConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: WildvineConfig, agentId: string): boolean {
