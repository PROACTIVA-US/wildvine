...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: WildvineConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: WildvineConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: WildvineConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: WildvineConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: WildvineConfig }): Promise<void> {
