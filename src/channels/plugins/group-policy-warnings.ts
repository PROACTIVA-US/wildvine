...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: WildvineConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: WildvineConfig }>(
  collector: WarningCollector<{ cfg: WildvineConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: WildvineConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: WildvineConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: WildvineConfig },
>(
  projectCfg: (cfg: WildvineConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  params: {
    providerConfigPresent: (cfg: WildvineConfig) => boolean;
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: WildvineConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: WildvineConfig },
>(params: {
  providerConfigPresent: (cfg: WildvineConfig) => boolean;
