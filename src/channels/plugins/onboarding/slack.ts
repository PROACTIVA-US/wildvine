...
function setSlackDmPolicy(cfg: WildvineConfig, dmPolicy: DmPolicy) {
...
function setSlackAllowFrom(cfg: WildvineConfig, allowFrom: string[]): WildvineConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
