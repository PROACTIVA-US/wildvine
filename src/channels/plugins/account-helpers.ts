...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: WildvineConfig): string | undefined {
  ...
  function listAccountIds(cfg: WildvineConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: WildvineConfig): string {
