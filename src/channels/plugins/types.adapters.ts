...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: WildvineConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: WildvineConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: WildvineConfig) => string;
  setAccountEnabled?: (params: {
    cfg: WildvineConfig;
    accountId: string;
    enabled: boolean;
  }) => WildvineConfig;
  deleteAccount?: (params: { cfg: WildvineConfig; accountId: string }) => WildvineConfig;
  isEnabled?: (account: ResolvedAccount, cfg: WildvineConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: WildvineConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: WildvineConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: WildvineConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: WildvineConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.wildvine.com/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: WildvineConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: WildvineConfig;
    nextCfg: WildvineConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelApprovalDeliveryAdapter = {
  hasConfiguredDmRoute?: (params: { cfg: WildvineConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: WildvineConfig; accountId?: string | null }) =>
    | {
...
export type ChannelConversationBindingSupport = {
  ...
  createManager?: (params: { cfg: WildvineConfig; accountId?: string | null }) =>
    | {
