...
export type ChannelAgentToolFactory = (params: { cfg?: WildvineConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: WildvineConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: WildvineConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: WildvineConfig }) => boolean;
  supportsCards?: (params: { cfg: WildvineConfig }) => boolean;
