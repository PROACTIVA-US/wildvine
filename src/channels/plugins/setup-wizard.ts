...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: WildvineConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: WildvineConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: WildvineConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: WildvineConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: WildvineConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: WildvineConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: WildvineConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: WildvineConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: WildvineConfig;
    accountId: string;
