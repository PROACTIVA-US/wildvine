...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: WildvineConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: WildvineConfig, mode: ChannelAuthMode): string {
