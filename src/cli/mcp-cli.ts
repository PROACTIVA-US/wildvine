...
import { serveWildvineChannelMcp } from "../mcp/channel-server.js";
...
export function registerMcpCli(program: Command) {
  const mcp = program.command("mcp").description("Manage Wildvine MCP config and channel bridge");

  mcp
    .command("serve")
    .description("Expose Wildvine channels over MCP stdio")
