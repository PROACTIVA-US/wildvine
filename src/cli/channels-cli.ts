    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["wildvine channels list", "List configured channels and auth profiles."],
          ["wildvine channels status --probe", "Run channel status checks and probes."],
          [
            "wildvine channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["wildvine channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.wildvine.com/cli/channels",
        )}\n`,
    );
