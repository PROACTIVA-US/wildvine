    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["wildvine directory self --channel slack", "Show the connected account identity."],
          [
            'wildvine directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["wildvine directory groups list --channel discord", "List available groups/channels."],
          [
            "wildvine directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.wildvine.com/cli/directory",
        )}\n`,
    )
    .action(() => {
