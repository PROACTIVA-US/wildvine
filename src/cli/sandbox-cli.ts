...
const SANDBOX_EXAMPLES = {
  main: [
    ["wildvine sandbox list", "List all sandbox containers."],
    ["wildvine sandbox list --browser", "List only browser containers."],
    ["wildvine sandbox recreate --all", "Recreate all containers."],
    ["wildvine sandbox recreate --session main", "Recreate a specific session."],
    ["wildvine sandbox recreate --agent mybot", "Recreate agent containers."],
    ["wildvine sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["wildvine sandbox list", "List all sandbox containers."],
    ["wildvine sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["wildvine sandbox recreate --all", "Recreate all containers."],
    ["wildvine sandbox recreate --session main", "Recreate a specific session."],
    ["wildvine sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["wildvine sandbox recreate --browser --all", "Recreate only browser containers."],
    ["wildvine sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["wildvine sandbox explain", "Show effective sandbox config."],
    ["wildvine sandbox explain --session agent:main:main", "Explain a specific session."],
    ["wildvine sandbox explain --agent work", "Explain an agent sandbox."],
    ["wildvine sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.wildvine.com/cli/sandbox")}\n`,
    )
    .action(() => {
