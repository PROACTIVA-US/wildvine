...
vi.mock("../../config/config.js", () => ({
  getConfigPath: () => "/tmp/wildvine-test-missing-config.json",
...
describe("gateway run option collisions", () => {
  ...
  it.each([
    ...
    delete process.env.WILDVINE_CLI_BACKEND_LOG_OUTPUT;
    ...
    expect(process.env.WILDVINE_CLI_BACKEND_LOG_OUTPUT).toBe("1");
  });
