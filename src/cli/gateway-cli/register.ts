      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["wildvine gateway run", "Run the gateway in the foreground."],
            ["wildvine gateway status", "Show service status and probe reachability."],
            ["wildvine gateway discover", "Find local and wide-area gateway beacons."],
            ["wildvine gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.wildvine.com/cli/gateway")}\n`,
      ),
  );
