const DEFAULT_TAGLINE = "All your chats, one Wildvine.";
...
const TAGLINES: string[] = [
  ...
  "I'll butter your workflow like a vine roll: messy, delicious, effective.",
  ...
  "Built by vines, for humans. Don't question the hierarchy.",
  ...
  "You had me at 'wildvine gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.WILDVINE_TAGLINE_INDEX;
