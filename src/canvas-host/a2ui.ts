...
export const A2UI_PATH = "/__wildvine__/a2ui";

export const CANVAS_HOST_PATH = "/__wildvine__/canvas";

export const CANVAS_WS_PATH = "/__wildvine__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.wildvineCanvasA2UIAction.postMessage(...)
  // - Android: window.wildvineCanvasA2UIAction.postMessage(...)
  const handlerNames = ["wildvineCanvasA2UIAction"];
  ...
  globalThis.Wildvine = globalThis.Wildvine ?? {};
  globalThis.Wildvine.postMessage = postToNode;
  globalThis.Wildvine.sendUserAction = sendUserAction;
  globalThis.wildvinePostMessage = postToNode;
  globalThis.wildvineSendUserAction = sendUserAction;
