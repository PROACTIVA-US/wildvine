...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.wildvine.com/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("wildvine hooks list")}`,
      `  ${formatCliCommand("wildvine hooks enable <name>")}`,
      `  ${formatCliCommand("wildvine hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
