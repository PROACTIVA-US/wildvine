...
type PromptDefaultModelResult = { model?: string; config?: WildvineConfig };
...
function resolveConfiguredModelRaw(cfg: WildvineConfig): string {
...
function resolveConfiguredModelKeys(cfg: WildvineConfig): string[] {
...
export function applyPrimaryModel(cfg: WildvineConfig, model: string): WildvineConfig {
...
export function applyModelAllowlist(cfg: WildvineConfig, models: string[]): WildvineConfig {
  const defaults = cfg.agents?.defaults;
