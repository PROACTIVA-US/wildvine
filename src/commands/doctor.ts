...
function resolveMode(cfg: WildvineConfig): "local" | "remote" {
...
export async function doctorCommand(
  ...
  let cfg: WildvineConfig = configResult.cfg;
  ...
  if (shouldWriteConfig) {
    ...
    runtime.log(`Run "${formatCliCommand("wildvine doctor --fix")}" to apply changes.`);
  }
