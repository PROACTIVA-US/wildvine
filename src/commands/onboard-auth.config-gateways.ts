...
export function applyVercelAiGatewayProviderConfig(cfg: WildvineConfig): WildvineConfig {
...
export function applyVercelAiGatewayConfig(cfg: WildvineConfig): WildvineConfig {
