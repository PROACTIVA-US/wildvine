...
import { replaceConfigFile, type WildvineConfig } from "../../config/config.js";
...
function resolveCatalogChannelEntry(raw: string, cfg: WildvineConfig | null) {
...
export async function channelsAddCommand(
  ...
  const cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as WildvineConfig;
  ...
  // May trigger loadWildvinePlugins on cache miss (disk scan + jiti import)
