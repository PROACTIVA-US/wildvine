...
export function applyOpenrouterProviderConfig(cfg: WildvineConfig): WildvineConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: WildvineConfig): WildvineConfig {
...
export function applyMoonshotProviderConfig(cfg: WildvineConfig): WildvineConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: WildvineConfig): WildvineConfig {
...
export function applyMoonshotConfig(cfg: WildvineConfig): WildvineConfig {
...
export function applyMoonshotConfigCn(cfg: WildvineConfig): WildvineConfig {
...
export function applyKimiCodeProviderConfig(cfg: WildvineConfig): WildvineConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: WildvineConfig): WildvineConfig {
...
export function applySyntheticProviderConfig(cfg: WildvineConfig): WildvineConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: WildvineConfig): WildvineConfig {
...
export function applyXiaomiProviderConfig(cfg: WildvineConfig): WildvineConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: WildvineConfig): WildvineConfig {
...
export function applyXaiProviderConfig(cfg: WildvineConfig): WildvineConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: WildvineConfig): WildvineConfig {
...
export function applyQianfanProviderConfig(cfg: WildvineConfig): WildvineConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: WildvineConfig): WildvineConfig {
