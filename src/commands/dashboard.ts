...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set WILDVINE_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `wildvine dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Wildvine.");
  } else if (hint) {
    runtime.log(hint);
  }
}
