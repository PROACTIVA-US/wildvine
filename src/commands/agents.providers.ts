...
function resolveDefaultAccountId(cfg: WildvineConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: WildvineConfig): boolean {
...
export function summarizeBindings(cfg: WildvineConfig, bindings: AgentBinding[]): string[] {
