...
describe("onboard (non-interactive): gateway and remote auth", () => {
  ...
  beforeAll(async () => {
    ...
    tempHome = await fs.mkdtemp(path.join(os.tmpdir(), "wildvine-onboard-"));
  ...
  afterAll(async () => {
    ...
    process.env.WILDVINE_STATE_DIR = prev.stateDir;
    ...
    process.env.WILDVINE_GATEWAY_PASSWORD = prev.password;
  });
