...
function collectExecSafeBinScopes(cfg: WildvineConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: WildvineConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: WildvineConfig): {
