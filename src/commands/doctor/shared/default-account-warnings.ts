...
export function collectMissingDefaultAccountBindingWarnings(cfg: WildvineConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: WildvineConfig): string[] {
  const warnings: string[] = [];
