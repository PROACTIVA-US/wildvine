...
describe("resolveTaskScriptPath", () => {
  it.each([
    {
      name: "uses default path when WILDVINE_PROFILE is unset",
      env: { USERPROFILE: "C:\\Users\\test" },
      expected: path.join("C:\\Users\\test", ".wildvine", "gateway.cmd"),
    },
    {
      name: "uses profile-specific path when WILDVINE_PROFILE is set to a custom value",
      env: { USERPROFILE: "C:\\Users\\test", WILDVINE_PROFILE: "jbphoenix" },
      expected: path.join("C:\\Users\\test", ".wildvine-jbphoenix", "gateway.cmd"),
    },
    {
      name: "prefers WILDVINE_STATE_DIR over profile-derived defaults",
      env: {
        USERPROFILE: "C:\\Users\\test",
        WILDVINE_PROFILE: "rescue",
        WILDVINE_STATE_DIR: "C:\\State\\wildvine",
      },
      expected: path.join("C:\\State\\wildvine", "gateway.cmd"),
    },
    {
      name: "falls back to HOME when USERPROFILE is not set",
      env: { HOME: "/home/test", WILDVINE_PROFILE: "default" },
      expected: path.join("/home/test", ".wildvine", "gateway.cmd"),
    },
  ])("$name", ({ env, expected }) => {
...
describe("readScheduledTaskCommand", () => {
  ...
  it("reads script from WILDVINE_STATE_DIR override", async () => {
    await withScheduledTaskScript(
      {
        env: (tmpDir) => ({ WILDVINE_STATE_DIR: path.join(tmpDir, "custom-state") }),
