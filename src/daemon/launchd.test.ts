...
function expectLaunchctlEnableBootstrapOrder(env: Record<string, string | undefined>) {
  ...
  const label = "ai.wildvine.gateway";
...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.wildvine.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", WILDVINE_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.wildvine.com/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when WILDVINE_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.wildvine.gateway.plist",
    },
    {
      name: "uses profile-specific label when WILDVINE_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", WILDVINE_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.wildvine.jbphoenix.plist",
    },
    {
      name: "prefers WILDVINE_LAUNCHD_LABEL over WILDVINE_PROFILE",
      env: {
        HOME: "/Users/test",
    ...
    {
      name: "trims whitespace from WILDVINE_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        WILDVINE_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty WILDVINE_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        WILDVINE_PROFILE: "myprofile",
        WILDVINE_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.wildvine.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
