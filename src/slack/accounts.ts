...
export function listSlackAccountIds(cfg: WildvineConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: WildvineConfig): string {
...
function mergeSlackAccountConfig(cfg: WildvineConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: WildvineConfig): ResolvedSlackAccount[] {
