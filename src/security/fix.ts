...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof WildvineConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: WildvineConfig; env: NodeJS.ProcessEnv }): {
  cfg: WildvineConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
