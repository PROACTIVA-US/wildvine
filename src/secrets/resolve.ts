...
function resolveResolutionLimits(config: WildvineConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: WildvineConfig): SecretProviderConfig {
