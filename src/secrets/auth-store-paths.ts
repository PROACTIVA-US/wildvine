...
export function listAuthProfileStorePaths(config: WildvineConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: WildvineConfig, stateDir: string): string[] {
