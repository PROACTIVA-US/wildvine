...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("WILDVINE_GATEWAY_TOKEN", "");
    vi.stubEnv("WILDVINE_GATEWAY_PASSWORD", "");
    vi.stubEnv("WILDVINE_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses WILDVINE_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
  ...
  it.each([
    ...
    },
    {
      ...
      options: {
        env: {
          WILDVINE_GATEWAY_TOKEN: "new-token",
        },
