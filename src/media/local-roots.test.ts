...
describe("local media roots", () => {
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "wildvine-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "wildvine-agent-media-roots-state"),
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "wildvine-flexible-media-roots-state"),
      cfg: {},
      shouldContainPictures: false,
    },
    {
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "wildvine-messaging-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "wildvine-messaging-fs-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
  ...
  it("keeps agent-scoped defaults even when mediaSources include file URLs and top-level paths", () => {
    const stateDir = path.join("/tmp", "wildvine-file-url-media-roots-state");
    const picturesDir =
