...
import type { WildvineConfig, ModelProviderConfig } from "../config/types.js";
...
const GATEWAY_LIVE = isTruthyEnvValue(process.env.WILDVINE_LIVE_GATEWAY);
...
async function runGatewayModelSuite(params: GatewayModelSuiteParams) {
  ...
  await ensureWildvineModelsJson(nextCfg);
