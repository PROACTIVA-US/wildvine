import type { GatewayAuthConfig, WildvineConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: WildvineConfig, password: string): WildvineConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
