 ...
 *
 * @see https://github.com/PROACTIVA-US/wildvine/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an WildvineConfig.
 */
export function timestampOptsFromConfig(cfg: WildvineConfig): TimestampInjectionOptions {
  return {
