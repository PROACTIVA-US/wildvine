...
function resolveImportedExternalId(message: unknown): string | undefined {
  ...
  const meta =
    "__wildvine" in message &&
    (message as { __wildvine?: unknown }).__wildvine &&
    typeof (message as { __wildvine?: unknown }).__wildvine === "object"
      ? ((message as { __wildvine?: Record<string, unknown> }).__wildvine ?? {})
      : undefined;
