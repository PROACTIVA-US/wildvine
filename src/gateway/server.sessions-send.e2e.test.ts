...
import { createWildvineTools } from "../agents/wildvine-tools.js";
...
beforeAll(async () => {
  prevGatewayPort = process.env.WILDVINE_GATEWAY_PORT;
  prevGatewayToken = process.env.WILDVINE_GATEWAY_TOKEN;
