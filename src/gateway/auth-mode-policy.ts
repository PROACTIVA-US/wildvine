...
export function hasAmbiguousGatewayAuthModeConfig(cfg: WildvineConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: WildvineConfig): void {
