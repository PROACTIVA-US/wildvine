...
export function collectConfiguredModelPricingRefs(config: WildvineConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: WildvineConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
