...
import type { WildvinePluginDefinition, WildvinePluginModule } from "./types.js";
...
function applyVitestCapabilityAliasOverrides(params: {
  ...
  const { ["wildvine/plugin-sdk"]: _ignoredRootAlias, ...scopedAliasMap } = params.aliasMap;
  return {
    ...scopedAliasMap,
...
function resolvePluginModuleExport(moduleExport: unknown): {
  ...
  if (resolved && typeof resolved === "object") {
    const definition = resolved as WildvinePluginDefinition;
    return {
      definition,
