...
function resolvePackageChannelMeta(
  packageManifest: WildvinePackageManifest | undefined,
  channelId: string,
): WildvinePackageManifest["channel"] | undefined {
...
export function listBundledPluginMetadata(params?: {
  ...
  const rootDir = path.resolve(params?.rootDir ?? WILDVINE_PACKAGE_ROOT);
