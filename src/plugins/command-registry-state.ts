...
import type { WildvinePluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = WildvinePluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("wildvine.pluginCommandsState");
