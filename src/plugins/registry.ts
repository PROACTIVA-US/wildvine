...
import type {
  ...
  WildvinePluginApi,
  WildvinePluginChannelRegistration,
  WildvinePluginCliCommandDescriptor,
  WildvinePluginCliRegistrar,
  WildvinePluginCommandDefinition,
  PluginConversationBindingResolvedEvent,
  WildvinePluginHttpRouteAuth,
  WildvinePluginHttpRouteMatch,
  WildvinePluginHttpRouteHandler,
  WildvinePluginHttpRouteParams,
  WildvinePluginHookOptions,
...
export type PluginToolRegistration = {
  pluginId: string;
  pluginName?: string;
  factory: WildvinePluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
  rootDir?: string;
...
export type PluginCliRegistration = {
  pluginId: string;
  pluginName?: string;
  register: WildvinePluginCliRegistrar;
  commands: string[];
...
export type PluginCommandRegistration = {
  pluginId: string;
  pluginName?: string;
  command: WildvinePluginCommandDefinition;
  source: string;
  rootDir?: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: WildvinePluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: WildvinePluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: WildvinePluginHookOptions | undefined,
    config: WildvinePluginApi["config"],
  ) => {
  ...
  const registerHttpRoute = (record: PluginRecord, params: WildvinePluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: WildvinePluginChannelRegistration | ChannelPlugin,
    mode: PluginRegistrationMode = "full",
  ) => {
    const normalized =
      typeof (registration as WildvinePluginChannelRegistration).plugin === "object"
        ? (registration as WildvinePluginChannelRegistration)
  ...
  const registerCli = (
    ...
    opts?: { commands?: string[]; descriptors?: WildvinePluginCliCommandDescriptor[] },
  ) => {
  ...
  const registerService = (record: PluginRecord, service: WildvinePluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: WildvinePluginCommandDefinition) => {
