...
import { normalizeWildvineVersionBase } from "../config/version.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeWildvineVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeWildvineVersionBase(plugin.version) ??
    plugin.version
  );
}
