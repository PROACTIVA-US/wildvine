...
export function applyGoogleGeminiModelDefault(cfg: WildvineConfig): {
  next: WildvineConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: WildvineConfig): WildvineConfig {
...
export function applyOpenAIConfig(cfg: WildvineConfig): WildvineConfig {
...
export function applyOpencodeGoModelDefault(cfg: WildvineConfig): {
  next: WildvineConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: WildvineConfig): {
  next: WildvineConfig;
  changed: boolean;
} {
