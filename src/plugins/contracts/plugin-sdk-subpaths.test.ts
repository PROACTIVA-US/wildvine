...
import type {
  ...
  WildvinePluginApi as CoreWildvinePluginApi,
  PluginRuntime as CorePluginRuntime,
} from "wildvine/plugin-sdk/core";
import * as providerEntrySdk from "wildvine/plugin-sdk/provider-entry";
...
import type {
  ...
  WildvinePluginApi as SharedWildvinePluginApi,
...
import type { WildvinePluginApi } from "../types.js";
...
describe("plugin-sdk subpath exports", () => {
  ...
  it("keeps shared plugin-sdk types aligned", () => {
    ...
    expectTypeOf<CoreWildvinePluginApi>().toMatchTypeOf<WildvinePluginApi>();
    expectTypeOf<CorePluginRuntime>().toMatchTypeOf<PluginRuntime>();
    expectTypeOf<CoreChannelMessageActionContext>().toMatchTypeOf<ChannelMessageActionContext>();
    expectTypeOf<CoreWildvinePluginApi>().toMatchTypeOf<SharedWildvinePluginApi>();
  ...
  it("keeps runtime entry subpaths importable", async () => {
    const [
      ...
      importResolvedPluginSdkSubpath("wildvine/plugin-sdk/core"),
      importResolvedPluginSdkSubpath("wildvine/plugin-sdk/channel-actions"),
      importResolvedPluginSdkSubpath("wildvine/plugin-sdk/global-singleton"),
      importResolvedPluginSdkSubpath("wildvine/plugin-sdk/text-runtime"),
      importResolvedPluginSdkSubpath("wildvine/plugin-sdk/huggingface"),
      importResolvedPluginSdkSubpath("wildvine/plugin-sdk/plugin-entry"),
      importResolvedPluginSdkSubpath("wildvine/plugin-sdk/channel-lifecycle"),
      importResolvedPluginSdkSubpath("wildvine/plugin-sdk/channel-pairing"),
      importResolvedPluginSdkSubpath("wildvine/plugin-sdk/channel-reply-pipeline"),
      ...representativeRuntimeSmokeSubpaths.map((id) =>
        importResolvedPluginSdkSubpath(`wildvine/plugin-sdk/${id}`),
      ),
    ]);
