...
export const PLUGIN_MANIFEST_FILENAME = "wildvine.plugin.json";
...
// package.json "wildvine" metadata (used for setup/catalog)
...
export type WildvinePackageStartup = {
  /**
...
export type WildvinePackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: WildvinePackageStartup;
};
...
): WildvinePackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
