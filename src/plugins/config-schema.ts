...
import type { PluginConfigUiHint, WildvinePluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: WildvinePluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): WildvinePluginConfigSchema {
  return {
