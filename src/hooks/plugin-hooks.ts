...
import type { WildvinePluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: WildvinePluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: WildvinePluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
