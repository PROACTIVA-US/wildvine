/**
 * Standalone MCP server that exposes Wildvine plugin-registered tools
...
function resolveTools(config: WildvineConfig): AnyAgentTool[] {
...
export function createPluginToolsMcpServer(
  ...
  const server = new Server(
    { name: "wildvine-plugin-tools", version: VERSION },
    { capabilities: { tools: {} } },
  );
