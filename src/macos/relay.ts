...
const BUNDLED_VERSION =
  (typeof __WILDVINE_VERSION__ === "string" && __WILDVINE_VERSION__) ||
  process.env.WILDVINE_BUNDLED_VERSION ||
  "0.0.0";
...
async function main() {
  ...
  const { ensureWildvineCliOnPath } = await import("../infra/path-env.js");
