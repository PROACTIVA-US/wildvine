...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.WILDVINE_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.WILDVINE_SERVICE_MARKER;
    vi.useRealTimers();
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.WILDVINE_SERVICE_MARKER = originalServiceMarker;
    }
  });
