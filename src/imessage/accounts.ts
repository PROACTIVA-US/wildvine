...
export function listIMessageAccountIds(cfg: WildvineConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: WildvineConfig): string {
...
function mergeIMessageAccountConfig(cfg: WildvineConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: WildvineConfig): ResolvedIMessageAccount[] {
