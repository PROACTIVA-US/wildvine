...
describe("plugin activation boundary", () => {
  ...
  let browserHelpersPromise:
    | Promise<{
        ...
        DEFAULT_WILDVINE_BROWSER_COLOR: typeof import("./plugin-sdk/browser-runtime.js").DEFAULT_WILDVINE_BROWSER_COLOR;
        DEFAULT_WILDVINE_BROWSER_PROFILE_NAME: typeof import("./plugin-sdk/browser-runtime.js").DEFAULT_WILDVINE_BROWSER_PROFILE_NAME;
  ...
  function importBrowserHelpers() {
    browserHelpersPromise ??= import("./plugin-sdk/browser-runtime.js").then((module) => ({
      ...
      DEFAULT_WILDVINE_BROWSER_COLOR: module.DEFAULT_WILDVINE_BROWSER_COLOR,
      DEFAULT_WILDVINE_BROWSER_PROFILE_NAME: module.DEFAULT_WILDVINE_BROWSER_PROFILE_NAME,
  ...
  it("does not load the browser plugin for static browser config helpers", async () => {
    ...
    expect(browser.DEFAULT_WILDVINE_BROWSER_COLOR).toBe("#FF4500");
    expect(browser.DEFAULT_WILDVINE_BROWSER_PROFILE_NAME).toBe("wildvine");
    ...
    expect(browser.resolveProfile(resolved, "wildvine")).toEqual(
