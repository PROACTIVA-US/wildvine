...
import type { WildvineConfig } from "./config-runtime.js";
...
type ApproverRestrictedNativeApprovalParams = {
  ...
  isNativeDeliveryEnabled: (params: { cfg: WildvineConfig; accountId?: string | null }) => boolean;
...
function buildApproverRestrictedNativeApprovalCapability(
  ...
  return createChannelApprovalCapability({
    ...
    approvals: {
      delivery: {
        hasConfiguredDmRoute: ({ cfg }: { cfg: WildvineConfig }) =>
