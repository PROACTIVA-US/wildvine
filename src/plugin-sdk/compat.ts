...
const shouldWarnCompatImport =
  ...
  process.env.WILDVINE_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "wildvine/plugin-sdk/compat is deprecated for new plugins. Migrate to focused wildvine/plugin-sdk/<subpath> imports. See https://docs.wildvine.com/plugins/sdk-migration",
    {
      code: "WILDVINE_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.wildvine.com/plugins/sdk-migration",
    },
  );
}
