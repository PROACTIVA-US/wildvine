...
export const DEFAULT_WILDVINE_BROWSER_ENABLED = true;
export const DEFAULT_BROWSER_EVALUATE_ENABLED = true;
export const DEFAULT_WILDVINE_BROWSER_COLOR = "#FF4500";
export const DEFAULT_WILDVINE_BROWSER_PROFILE_NAME = "wildvine";
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "wildvine";
export const DEFAULT_AI_SNAPSHOT_MAX_CHARS = 80_000;

const DEFAULT_FALLBACK_BROWSER_TMP_DIR = "/tmp/wildvine";
...
export type ResolvedBrowserProfile = {
  ...
  userDataDir?: string;
  color: string;
  driver: "wildvine" | "existing-session";
  attachOnly: boolean;
};
...
export function resolveBrowserConfig(
  ...
  const defaultProfile =
    ...
    (profiles[DEFAULT_BROWSER_DEFAULT_PROFILE_NAME]
      ...
      : profiles[DEFAULT_WILDVINE_BROWSER_PROFILE_NAME]
...
export function resolveProfile(
  ...
  let cdpUrl = "";
  const driver = profile.driver === "existing-session" ? "existing-session" : "wildvine";
