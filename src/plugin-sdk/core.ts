...
import type { WildvinePluginApi, WildvinePluginConfigSchema } from "../plugins/types.js";
...
export type { WildvinePluginToolContext, WildvinePluginToolFactory } from "../plugins/types.js";
...
type DefineChannelPluginEntryOptions<TPlugin = ChannelPlugin> = {
  ...
  registerCliMetadata?: (api: WildvinePluginApi) => void;
  registerFull?: (api: WildvinePluginApi) => void;
};
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: WildvineConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
