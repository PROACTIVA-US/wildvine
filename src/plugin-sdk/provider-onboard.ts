...
export type { WildvineConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: WildvineConfig, ...args: TArgs) => WildvineConfig;
  applyConfig: (cfg: WildvineConfig, ...args: TArgs) => WildvineConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: WildvineConfig, preset: TParams) => WildvineConfig;
  primaryModelRef: string;
