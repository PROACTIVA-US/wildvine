...
export function listWhatsAppAuthDirs(cfg: WildvineConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: WildvineConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: WildvineConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: WildvineConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: WildvineConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: WildvineConfig): ResolvedWhatsAppAccount[] {
