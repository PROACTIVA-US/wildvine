...
export function listSignalAccountIds(cfg: WildvineConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: WildvineConfig): string {
...
function mergeSignalAccountConfig(cfg: WildvineConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: WildvineConfig): ResolvedSignalAccount[] {
