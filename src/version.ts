...
declare const __WILDVINE_VERSION__: string | undefined;
const CORE_PACKAGE_NAME = "wildvine";
...
function resolveVersionFromRuntimeSources(params: {
  ...
  const preferredCandidates =
    params.preference === "env-first"
      ? [params.env["WILDVINE_VERSION"], params.runtimeVersion]
      : [params.runtimeVersion, params.env["WILDVINE_VERSION"]];
  return (
    firstNonEmpty(
      ...preferredCandidates,
      params.env["WILDVINE_SERVICE_VERSION"],
...
// Single source of truth for the current Wildvine version.
// - Embedded/bundled builds: injected define or env var.
// - Dev/npm builds: package.json.
export const VERSION = resolveBinaryVersion({
  moduleUrl: import.meta.url,
  injectedVersion: typeof __WILDVINE_VERSION__ === "string" ? __WILDVINE_VERSION__ : undefined,
  bundledVersion: process.env.WILDVINE_BUNDLED_VERSION,
});
