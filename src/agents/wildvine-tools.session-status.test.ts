...
const buildStatusMessageMock = vi.hoisted(() => vi.fn(() => "Wildvine\n🧠 Model: GPT-5.4"));
...
async function loadFreshWildvineToolsForSessionStatusTest() {
  vi.resetModules();
...
describe("session_status tool", () => {
  beforeEach(async () => {
    buildStatusMessageMock.mockClear();
    await loadFreshWildvineToolsForSessionStatusTest();
  });
