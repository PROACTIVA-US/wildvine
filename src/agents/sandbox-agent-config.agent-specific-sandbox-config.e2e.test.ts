...
async function resolveContext(config: WildvineConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): WildvineConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
