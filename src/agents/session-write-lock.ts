...
const CLEANUP_STATE_KEY = Symbol.for("wildvine.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("wildvine.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("wildvine.sessionWriteLockWatchdogState");
