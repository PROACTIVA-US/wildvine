...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<WildvineConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<WildvineConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: WildvineConfig): WebSearchConfig {
