...
export const DEFAULT_SANDBOX_IMAGE = "wildvine-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "wildvine-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "wildvine-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "wildvine-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "wildvine-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "wildvine-sandbox-browser";
