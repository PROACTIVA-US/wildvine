...
const WILDVINE_ATTRIBUTION_PRODUCT = "Wildvine";
const WILDVINE_ATTRIBUTION_ORIGINATOR = "wildvine";

export function resolveProviderAttributionIdentity(
  env: RuntimeVersionEnv = process.env as RuntimeVersionEnv,
): ProviderAttributionIdentity {
  return {
    product: WILDVINE_ATTRIBUTION_PRODUCT,
...
function buildOpenAIAttributionPolicy(
  ...
  return {
    ...
    ...identity,
    headers: {
      originator: WILDVINE_ATTRIBUTION_ORIGINATOR,
      version: identity.version,
      "User-Agent": `${WILDVINE_ATTRIBUTION_ORIGINATOR}/${identity.version}`,
    },
  };
}
