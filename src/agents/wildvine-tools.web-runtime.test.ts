...
function requireWebSearchTool(config: WildvineConfig, runtimeWebSearch?: RuntimeWebSearchMetadata) {
...
async function prepareAndActivate(params: { config: WildvineConfig; env?: NodeJS.ProcessEnv }) {
...
describe("wildvine tools runtime web metadata wiring", () => {
