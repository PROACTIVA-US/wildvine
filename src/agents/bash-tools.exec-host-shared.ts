...
export function buildHeadlessExecApprovalDeniedMessage(params: {
  ...
  return [
    ...
    "Stricter values from tools.exec and ~/.wildvine/exec-approvals.json both apply.",
    "Fix one of these:",
    ...
    'Tip: run "wildvine doctor" and "wildvine approvals get --gateway" to inspect the effective policy.',
  ].join("\n");
}
