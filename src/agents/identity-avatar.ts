...
function resolveAvatarSource(cfg: WildvineConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: WildvineConfig, agentId: string): AgentAvatarResolution {
