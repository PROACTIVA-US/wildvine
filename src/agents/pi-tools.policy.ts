...
export function resolveSubagentToolPolicy(cfg?: WildvineConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: WildvineConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: WildvineConfig["tools"];
