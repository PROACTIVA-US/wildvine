...
function resolveAdaptiveReadMaxBytes(options?: WildvineReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createWildvineReadTool(base, {
...
export function createWildvineReadTool(
  base: AnyAgentTool,
  options?: WildvineReadToolOptions,
): AnyAgentTool {
