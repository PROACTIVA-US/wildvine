...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveWildvineAgentDir() returns mainAgentDir
    process.env.WILDVINE_STATE_DIR = tmpDir;
    process.env.WILDVINE_AGENT_DIR = mainAgentDir;
