...
function resolveWatchPaths(workspaceDir: string, config?: WildvineConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: WildvineConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: WildvineConfig }) {
