...
type WildvineToolsDeps = {
  callGateway: typeof callGateway;
  config?: WildvineConfig;
};

const defaultWildvineToolsDeps: WildvineToolsDeps = {
  callGateway,
};

let openClawToolsDeps: WildvineToolsDeps = defaultWildvineToolsDeps;

export function createWildvineTools(
  options?: {
...
export const __testing = {
  setDepsForTest(overrides?: Partial<WildvineToolsDeps>) {
    openClawToolsDeps = overrides
      ? {
          ...defaultWildvineToolsDeps,
          ...overrides,
        }
      : defaultWildvineToolsDeps;
  },
