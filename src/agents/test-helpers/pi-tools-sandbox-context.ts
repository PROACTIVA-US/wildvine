...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "wildvine-sbx-test",
    runtimeLabel: params.containerName ?? "wildvine-sbx-test",
    containerName: params.containerName ?? "wildvine-sbx-test",
