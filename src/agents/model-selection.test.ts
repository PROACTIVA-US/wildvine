...
function resolveAnthropicOpusThinking(cfg: WildvineConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<WildvineConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<WildvineConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<WildvineConfig> = {
        agents: {
          defaults: {
            models: {
