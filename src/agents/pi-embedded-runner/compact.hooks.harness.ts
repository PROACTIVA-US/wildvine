...
export const createWildvineCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createWildvineCodingToolsMock.mockReset();
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureWildvineModelsJson: vi.fn(async () => {}),
  }));
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveWildvineDocsPath: vi.fn(async () => undefined),
  }));
  ...
  vi.doMock("../pi-tools.js", () => ({
    createWildvineCodingTools: createWildvineCodingToolsMock,
  }));
  ...
  vi.doMock("../agent-paths.js", () => ({
    resolveWildvineAgentDir: vi.fn(() => "/tmp"),
  }));
