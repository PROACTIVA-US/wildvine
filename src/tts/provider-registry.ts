...
function resolveSpeechProviderPluginEntries(cfg?: WildvineConfig): SpeechProviderPlugin[] {
...
function buildProviderMaps(cfg?: WildvineConfig): {
...
export function listSpeechProviders(cfg?: WildvineConfig): SpeechProviderPlugin[] {
