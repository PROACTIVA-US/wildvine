...
describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\bwildvine\b/i];
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: {
          identityName: "Wildvine",
          provider: "anthropic",
          model: "claude-opus-4-5",
          thinkingLevel: "high",
        },
        expected: "[Wildvine] anthropic/claude-opus-4-5 (think:high)",
      },
    ] as const;
