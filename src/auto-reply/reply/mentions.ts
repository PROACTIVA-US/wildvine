...
function resolveMentionPatterns(cfg: WildvineConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: WildvineConfig | undefined, agentId?: string): RegExp[] {
