...
function resolveAcpStreamCoalesceIdleMs(cfg: WildvineConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: WildvineConfig): number {
...
export function resolveAcpProjectionSettings(cfg: WildvineConfig): AcpProjectionSettings {
