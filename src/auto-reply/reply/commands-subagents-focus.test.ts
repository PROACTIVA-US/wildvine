...
function createMatrixThreadCommandParams(commandBody: string, cfg: WildvineConfig = baseCfg) {
...
function createMatrixRoomCommandParams(commandBody: string, cfg: WildvineConfig = baseCfg) {
  const params = buildCommandTestParams(commandBody, cfg, {
    Provider: "matrix",
    Surface: "matrix",
    OriginatingChannel: "matrix",
