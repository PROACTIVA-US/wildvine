...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@wildvine", { botUsername: "wildvine" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@wildvine args", {
        botUsername: "wildvine",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@wildvine: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "wildvine" })).toBe(
      "/help@otherbot",
    );
  });
