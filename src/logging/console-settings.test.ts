...
let originalWildvineTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalWildvineTestConsole = process.env.WILDVINE_TEST_CONSOLE;
  process.env.WILDVINE_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalWildvineTestConsole === undefined) {
    delete process.env.WILDVINE_TEST_CONSOLE;
  } else {
    process.env.WILDVINE_TEST_CONSOLE = originalWildvineTestConsole;
  }
