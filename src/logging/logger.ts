...
export const DEFAULT_LOG_DIR = resolvePreferredWildvineTmpDir();
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "wildvine.log"); // legacy single-file path
