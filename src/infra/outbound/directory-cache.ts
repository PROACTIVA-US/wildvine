...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: WildvineConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: WildvineConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: WildvineConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: WildvineConfig): void {
