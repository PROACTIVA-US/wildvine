...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("wildvine.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("wildvine.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: WildvineConfig): Promise<ContextEngine> {
