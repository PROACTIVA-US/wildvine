...
export const FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.memorySearch.store.path":
    "SQLite index path (default: ~/.wildvine/memory/{agentId}.sqlite).",
  ...
  "memory.backend": 'Memory backend ("builtin" for Wildvine embeddings, "qmd" for QMD sidecar).',
  ...
  "plugins.installs.*.installPath":
    "Resolved install directory (usually ~/.wildvine/extensions/<id>).",
