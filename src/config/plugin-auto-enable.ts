...
function isTelegramConfigured(cfg: WildvineConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: WildvineConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: WildvineConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: WildvineConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: WildvineConfig): boolean {
...
function isIMessageConfigured(cfg: WildvineConfig): boolean {
...
function isWhatsAppConfigured(cfg: WildvineConfig): boolean {
...
function isGenericChannelConfigured(cfg: WildvineConfig, channelId: string): boolean {
