...
function resolveAnthropicDefaultAuthMode(cfg: WildvineConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: WildvineConfig): WildvineConfig {
...
export function applyTalkApiKey(config: WildvineConfig): WildvineConfig {
...
export function applyTalkConfigNormalization(config: WildvineConfig): WildvineConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: WildvineConfig): WildvineConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: WildvineConfig): WildvineConfig {
...
export function applyLoggingDefaults(cfg: WildvineConfig): WildvineConfig {
...
export function applyContextPruningDefaults(cfg: WildvineConfig): WildvineConfig {
...
export function applyCompactionDefaults(cfg: WildvineConfig): WildvineConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
