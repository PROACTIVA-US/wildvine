...
function makeRegistry(
  ...
  return {
    plugins: plugins.map((p) => ({
      ...
      manifestPath: `/fake/${p.id}/wildvine.plugin.json`,
    })),
    diagnostics: [],
  };
}
...
describe("applyPluginAutoEnable", () => {
        ...
        entries: [
          {
            ...
            wildvine: {
              ...
              install: {
                npmSpec: "@wildvine/env-secondary",
              },
            },
          },
        ],
        ...
        plugins: [
          {
            ...
            manifestPath: "/fake/acme/wildvine.plugin.json",
            contracts: {
  ...
  describe("third-party channel plugins (pluginId ≠ channelId)", () => {
    it("uses the plugin manifest id, not the channel id, for plugins.entries", () => {
      // Reproduces: https://github.com/PROACTIVA-US/wildvine/issues/25261
