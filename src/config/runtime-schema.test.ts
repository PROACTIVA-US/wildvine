...
import type { ConfigFileSnapshot, WildvineConfig } from "./types.js";

const mockLoadConfig = vi.hoisted(() => vi.fn<() => WildvineConfig>());
...
function makeSnapshot(params: { valid: boolean; config?: WildvineConfig }): ConfigFileSnapshot {
  return {
