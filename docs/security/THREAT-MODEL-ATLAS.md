...
This is a living document maintained by the Wildvine community. See [CONTRIBUTING-THREAT-MODEL.md](./CONTRIBUTING-THREAT-MODEL.md) for guidelines on contributing:
...
This threat model documents adversarial threats to the Wildvine AI agent platform and WildvineHub skill marketplace, using the MITRE ATLAS framework designed specifically for AI/ML systems.

### 1.2 Scope

| Component               | Included | Notes                                            |
| ----------------------- | -------- | ------------------------------------------------ |
| Wildvine Agent Runtime  | Yes      | Core agent execution, tool calls, sessions       |
| Gateway                 | Yes      | Authentication, routing, channel integration     |
| Channel Integrations    | Yes      | WhatsApp, Telegram, Discord, Signal, Slack, etc. |
| WildvineHub Marketplace | Yes      | Skill publishing, moderation, distribution       |
...
| F5   | WildvineHub | Agent       | Skill code         | Moderation, scanning |
...
| **Description**         | Attacker scans for exposed Wildvine gateway endpoints                |
...
| **Affected Components** | ~/.wildvine/credentials/, config storage                    |
...
| **Description**         | Attacker publishes malicious skill to WildvineHub                        |
| **Attack Vector**       | Create account, publish skill with hidden malicious code                 |
| **Affected Components** | WildvineHub, skill loading, agent execution                              |
...
| **Affected Components** | WildvineHub versioning, auto-update flows                      |
...
| **Affected Components** | WildvineHub moderation.ts                                              |
...
## 4. WildvineHub Supply Chain Analysis
...
/(keepcold131\/WildvineAuthenticatorTool|WildvineAuthenticatorTool)/i
...
| ATLAS ID      | Technique Name                 | Wildvine Threats                                                 |
| ------------- | ------------------------------ | ---------------------------------------------------------------- |
...
| `convex/lib/moderation.ts`          | WildvineHub moderation      | **High**     |
...
| **WildvineHub**      | Wildvine's skill marketplace                              |
| **Gateway**          | Wildvine's message routing and authentication layer       |
| **MCP**              | Model Context Protocol - tool provider interface          |
| **Prompt Injection** | Attack where malicious instructions are embedded in input |
| **Skill**            | Downloadable extension for Wildvine agents                |
| **SSRF**             | Server-Side Request Forgery                               |

---

_This threat model is a living document. Report security issues to security@wildvine.ai_
