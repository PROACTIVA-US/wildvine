...
summary: "Wildvine threat model mapped to the MITRE ATLAS framework"
read_when:
...
This is a living document maintained by the Wildvine community. See [CONTRIBUTING-THREAT-MODEL.md](/security/CONTRIBUTING-THREAT-MODEL) for guidelines on contributing:
...
This threat model documents adversarial threats to the Wildvine AI agent platform and ClawHub skill marketplace, using the MITRE ATLAS framework designed specifically for AI/ML systems.
...
| **ClawHub**          | Wildvine's skill marketplace                              |
...
_This threat model is a living document. Report security issues to security@wildvine.com_
