...
Wildvine treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.wildvine/settings/voicewake.json`

Shape:

```json
{ "triggers": ["wildvine", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
