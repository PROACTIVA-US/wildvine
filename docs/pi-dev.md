...
This guide summarizes a sane workflow for working on the pi integration in Wildvine.
...
- Trigger the agent directly:
  - `pnpm wildvine agent --message "Hello" --thinking low`
...
State lives under the Wildvine state directory. Default is `~/.wildvine`. If `WILDVINE_STATE_DIR` is set, use that directory instead.

To reset everything:

- `wildvine.json` for config
...
- [https://docs.wildvine.bot/testing](https://docs.wildvine.bot/testing)
- [https://docs.wildvine.bot/start/getting-started](https://docs.wildvine.bot/start/getting-started)
