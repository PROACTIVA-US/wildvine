---
summary: "Host Wildvine on a DigitalOcean Droplet"
read_when:
  - Setting up Wildvine on DigitalOcean
  - Looking for a simple paid VPS for Wildvine
title: "DigitalOcean"
---

# DigitalOcean

Run a persistent Wildvine Gateway on a DigitalOcean Droplet.
...
**Gateway will not start** -- Run `wildvine doctor --non-interactive` and check logs with `journalctl --user -u wildvine-gateway.service -n 50`.
