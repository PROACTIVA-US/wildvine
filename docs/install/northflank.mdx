...
Deploy Wildvine on Northflank with a one-click template and finish setup in your browser.
...
8. Open the public Wildvine URL and complete setup at `/setup`.
9. Open the Control UI at `/wildvine`.
...
4. Click **Run setup**.
5. Open the Control UI at `https://<your-northflank-domain>/wildvine`
