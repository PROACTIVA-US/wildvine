...
Deploy Wildvine on Railway with a one-click template and finish setup in your browser.
...
<a href="https://railway.com/deploy/wildvinebot-railway-template" target="_blank" rel="noreferrer">
  Deploy on Railway
</a>
...
- `WILDVINE_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your Wildvine state + workspace so you can migrate to another host without losing config or memory.
