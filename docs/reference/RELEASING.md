...
Wildvine has three public release lanes:
...
- Run `RELEASE_TAG=vYYYY.M.D node --import tsx scripts/wildvine-npm-release-check.ts`
  (or the matching beta/correction tag) before approval
- After npm publish, run
  `node --import tsx scripts/wildvine-npm-postpublish-verify.ts YYYY.M.D`
...
- [`.github/workflows/wildvine-npm-release.yml`](https://github.com/PROACTIVA-US/wildvine/blob/main/.github/workflows/wildvine-npm-release.yml)
- [`scripts/wildvine-npm-release-check.ts`](https://github.com/PROACTIVA-US/wildvine/blob/main/scripts/wildvine-npm-release-check.ts)
- [`scripts/package-mac-dist.sh`](https://github.com/PROACTIVA-US/wildvine/blob/main/scripts/package-mac-dist.sh)
- [`scripts/make_appcast.sh`](https://github.com/PROACTIVA-US/wildvine/blob/main/scripts/make_appcast.sh)

Maintainers use the private release docs in
[`wildvine/maintainers/release/README.md`](https://github.com/PROACTIVA-US/maintainers/blob/main/release/README.md)
