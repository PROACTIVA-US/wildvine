...
This is the full reference for `wildvine onboard`.
...
<Steps>
  ...
  <Step title="Web search">
    ...
    - Configure later: `wildvine configure --section web`.
  </Step>
...
```bash
export WILDVINE_GATEWAY_TOKEN="your-token"
wildvine onboard --non-interactive \
  --mode local \
  --auth-choice skip \
  --gateway-auth token \
  --gateway-token-ref-env WILDVINE_GATEWAY_TOKEN
```
