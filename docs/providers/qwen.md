---
summary: "Use Qwen OAuth (free tier) in Wildvine"
read_when:
  - You want to use Qwen with Wildvine
...
If you already logged in with the Qwen Code CLI, Wildvine will sync credentials
