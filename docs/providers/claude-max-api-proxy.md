...
You can point Wildvine at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Wildvine
...
- [Anthropic provider](/providers/anthropic) - Native Wildvine integration with Claude setup-token or API keys
