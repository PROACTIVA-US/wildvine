---
summary: "Use NVIDIA's OpenAI-compatible API in Wildvine"
read_when:
  - You want to use NVIDIA models in Wildvine
...
wildvine onboard --auth-choice skip
wildvine models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
