---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Wildvine"
read_when:
  - You want Xiaomi MiMo models in Wildvine
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Wildvine uses
