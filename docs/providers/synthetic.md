---
summary: "Use Synthetic's Anthropic-compatible API in Wildvine"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Wildvine registers it as the
...
Note: Wildvine's Anthropic client appends `/v1` to the base URL, so use
