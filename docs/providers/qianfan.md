---
summary: "Use Qianfan's unified API to access many models in Wildvine"
read_when:
...
3. Wildvine installed on your system
...
4. Copy the API key for use with Wildvine

## CLI setup

```bash
wildvine onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Wildvine Configuration](/gateway/configuration)
