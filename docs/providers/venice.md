...
```bash
wildvine chat --model venice/llama-3.3-70b "Hello, are you working?"
```
...
```bash
wildvine models set venice/claude-opus-45
wildvine models set venice/llama-3.3-70b
```
...
wildvine chat --model venice/llama-3.3-70b

# Use Claude via Venice (anonymized)
wildvine chat --model venice/claude-opus-45

# Use uncensored model
wildvine chat --model venice/venice-uncensored

# Use vision model with image
wildvine chat --model venice/qwen3-vl-235b-a22b

# Use coding model
wildvine chat --model venice/qwen3-coder-480b-a35b-instruct
```
