...
wildvine system heartbeat last
wildvine logs --follow
wildvine config get agents.defaults.heartbeat
wildvine channels status --probe
```
...
```bash
wildvine config get agents.defaults.heartbeat.activeHours
wildvine config get agents.defaults.heartbeat.activeHours.timezone
wildvine config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
wildvine cron list
wildvine logs --follow
```
