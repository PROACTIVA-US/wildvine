---
summary: "How Wildvine summarizes long conversations to stay within model limits"
read_when:
...
When a conversation approaches that limit, Wildvine **compacts** older messages
...
Wildvine compacts and retries).

<Info>
Before compacting, Wildvine automatically reminds the agent to save important
