...
Wildvine has two separate “streaming” layers:
...
When block streaming is enabled, Wildvine can **merge consecutive block chunks**
...
When draft streaming is active, Wildvine disables block streaming for that reply to avoid double-streaming.
