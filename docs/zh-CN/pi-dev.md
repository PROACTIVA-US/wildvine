...
本指南总结了在 Wildvine 中开发 Pi 集成的合理工作流程。
...
状态存储在 Wildvine 状态目录下。默认为 `~/.wildvine`。如果设置了 `WILDVINE_STATE_DIR`，则使用该目录。
...
- https://docs.wildvine.bot/testing
- https://docs.wildvine.bot/start/getting-started
