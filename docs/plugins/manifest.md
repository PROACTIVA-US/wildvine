...
read_when:
  - You are building a Wildvine plugin
...
Every plugin **must** ship a `wildvine.plugin.json` file in the **plugin root**.
Wildvine uses this manifest to validate configuration **without executing plugin
