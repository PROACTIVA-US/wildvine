...
read_when:
  - You want to place an outbound voice call from Wildvine
...
Voice calls for Wildvine via a plugin. Supports outbound notifications and
...
- Use `wildvine voicecall ...` or the `voice_call` tool
...
wildvine voicecall start --to "+15555550123"   # alias for call
...
wildvine voicecall latency                     # summarize turn latency from logs
