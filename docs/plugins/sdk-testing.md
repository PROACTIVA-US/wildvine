...
summary: "Testing utilities and patterns for Wildvine plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for Wildvine
plugins.
...
**Import:** `wildvine/plugin-sdk/testing`
...
import { installCommonResolveTargetErrorCases } from "wildvine/plugin-sdk/testing";
...
import type { PluginRuntime } from "wildvine/plugin-sdk/runtime-store";
...
1. **No monolithic root imports** -- `wildvine/plugin-sdk` root barrel is rejected
...
Wildvine uses Vitest with V8 coverage thresholds. For plugin tests:
