...
Wildvine supports multiple onboarding paths depending on where the Gateway runs
...
- [`wildvine onboard` command](/cli/onboard)

## macOS app onboarding

Use the Wildvine app when you want a fully guided setup on macOS. Docs:
