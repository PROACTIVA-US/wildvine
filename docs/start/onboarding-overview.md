---
summary: "Overview of Wildvine onboarding options and flows"
read_when:
...
Wildvine has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `wildvine onboard`                     | Launch the app            |
...
CLI command docs: [`wildvine onboard`](/cli/onboard)

## macOS app onboarding

Open the Wildvine app. The first-run wizard walks you through the same steps
