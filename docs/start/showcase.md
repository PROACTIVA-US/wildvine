...
read_when:
  - Looking for real Wildvine usage examples
...
<Info>
**Want to be featured?** Share your project in [#self-promotion on Discord](https://discord.gg/clawd) or [tag @wildvine on X](https://x.com/wildvine).
</Info>
...
A scheduled prompt generates a single "scene" image each morning (weather, tasks, date, favorite post/quote) via an Wildvine persona.
</Card>
...
Wildvine connected to Jira, then generated a new skill on the fly (before it existed on ClawHub).
</Card>
...
<Card title="Nix Packaging" icon="snowflake" href="https://github.com/PROACTIVA-US/nix-wildvine">
...
<Steps>
  <Step title="Share It">
    Post in [#self-promotion on Discord](https://discord.gg/clawd) or [tweet @wildvine](https://x.com/wildvine)
  </Step>
