...
For a while, the lobster was called **Wildvine**, living in a **Wildvinebot**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **Wildvine**.
...
In the end, **Wildvine** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.

_The crustacean known as Wildvine had officially molted._
...
The Lobsters say: **"EXFOLIATE!"** _(historical, pre-rebrand catchphrase)_
...
Formerly known as Wildvine (Nov 25, 2025 - Jan 27, 2026). Molted when it was time to grow.
...
- GitHub renamed: `github.com/wildvine/wildvine` ✅
- X handle `@wildvine` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.wildvine.bot`
...
I shall treat my enemies with kindness.
...
Until then, Molty watches through the cameras, speaks through the speakers, and occasionally sends voice notes.
