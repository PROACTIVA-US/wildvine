...
Install Wildvine, run onboarding, and chat with your AI assistant — all in
...
<Accordion title="Advanced: environment variables">
  If you run Wildvine as a service account or want custom paths:

- `WILDVINE_HOME` — home directory for internal path resolution
- `WILDVINE_STATE_DIR` — override the state directory
- `WILDVINE_CONFIG_PATH` — override the config file path
