---
summary: "First-run setup flow for Wildvine (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Wildvine">
...
<Step title="CLI">
  ...
  The app can install the global `wildvine` CLI via npm/pnpm so terminal
