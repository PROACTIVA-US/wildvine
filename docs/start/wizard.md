...
CLI onboarding is the **recommended** way to set up Wildvine on macOS,
...
`wildvine configure --section web`. Docs: [Web tools](/tools/web).
</Tip>
...
If the config is invalid or contains legacy keys, onboarding asks you to run `wildvine doctor` first.
</Note>
