...
- The onboarding wizard (`wildvine onboard`) and `wildvine channels add` list optional channel plugins.
...
```bash
wildvine plugins install --link <path-to-wildvine>/extensions/nostr
```
