...
Wildvine treats group chats consistently across surfaces: Discord, iMessage, Matrix, Microsoft Teams, Signal, Slack, Telegram, WhatsApp, Zalo.

## Beginner intro (2 minutes)

Wildvine “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Wildvine can see that group and respond there.
...
Translation: allowlisted senders can trigger Wildvine by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@wildvine", "wildvine", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
