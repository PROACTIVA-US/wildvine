...
Feishu ships bundled with current Wildvine releases, so no separate plugin install
is required.
...
If you just installed Wildvine, run onboarding:
  ...
  agents: {
    list: [
      { id: "main" },
      {
        ...
        agentDir: "/home/user/.wildvine/agents/clawd-fan/agent",
      },
      {
        id: "clawd-xi",
        workspace: "/home/user/clawd-xi",
        agentDir: "/home/user/.wildvine/agents/clawd-xi/agent",
      },
    ],
  },
  bindings: [
