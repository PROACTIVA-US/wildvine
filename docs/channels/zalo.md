...
- Install via CLI: `wildvine plugins install @wildvine/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `wildvine plugins install ./path/to/local/zalo-plugin`
   - From npm (if published): `wildvine plugins install @wildvine/zalo`
...
This page reflects current Wildvine behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `wildvine pairing list zalo`
  - `wildvine pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Wildvine.
...
- Example: `wildvine message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `wildvine channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `wildvine logs --follow`
