...
echo "Running plugins Docker E2E..."
  ...
  mkdir -p "$HOME/.wildvine/extensions/demo-plugin"

  cat > "$HOME/.wildvine/extensions/demo-plugin/index.js" <<'"'"'JS'"'"'
module.exports = {
  id: "demo-plugin",
  name: "Demo Plugin",
...
JS
  cat > "$HOME/.wildvine/extensions/demo-plugin/wildvine.plugin.json" <<'"'"'JSON'"'"'
{
  "id": "demo-plugin",
  "configSchema": {
    "type": "object",
