...
const targetModel =
  modelIds.find((id) => id === "wildvine/default") ?? modelIds.find((id) => id === "wildvine");
if (!targetModel) {
  throw new Error(`wildvine model missing from Open WebUI model list: ${JSON.stringify(modelIds)}`);
}
