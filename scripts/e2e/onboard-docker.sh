...
TRASH
  ...
  send_skills_flow() {
    ...
    workspace_dir="$HOME/.wildvine/workspace"
    config_path="$HOME/.wildvine/wildvine.json"
    sessions_dir="$HOME/.wildvine/agents/main/sessions"
...
NODE
  ...
  run_case_reset() {
    ...
    # Seed a remote config to exercise reset path.
	    cat > "$HOME/.wildvine/wildvine.json" <<'"'"'JSON'"'"'
{
