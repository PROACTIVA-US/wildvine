...
export DISPLAY=:1
export HOME=/tmp/wildvine-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${WILDVINE_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${WILDVINE_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${WILDVINE_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${WILDVINE_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${WILDVINE_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${WILDVINE_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${WILDVINE_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${WILDVINE_BROWSER_NOVNC_PASSWORD:-}"
DISABLE_GRAPHICS_FLAGS="${WILDVINE_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${WILDVINE_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${WILDVINE_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
