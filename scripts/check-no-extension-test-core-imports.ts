...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']wildvine\/plugin-sdk["']/,
    hint: "Use wildvine/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']wildvine\/plugin-sdk\/test-utils["']/,
    hint: "Use wildvine/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']wildvine\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/plugins/* for repo-only helpers, or wildvine/plugin-sdk/testing for public surfaces.",
  },
  {
