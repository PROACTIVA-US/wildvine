...
export const OPTIONAL_BUNDLED_BUILD_ENV = "WILDVINE_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.wildvine?.install?.npmSpec === "string" &&
    packageJson.wildvine.install.npmSpec.trim().length > 0
  );
}
