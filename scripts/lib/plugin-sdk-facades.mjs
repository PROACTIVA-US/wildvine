...
function pluginSource(dirName, artifactBasename = "api.js") {
  return `@wildvine/${dirName}/${artifactBasename}`;
}
...
export const GENERATED_PLUGIN_SDK_FACADES = [
  ...
  },
  {
    ...
    directExports: {
      ...
      DEFAULT_WILDVINE_BROWSER_COLOR: "./browser-config.js",
      DEFAULT_WILDVINE_BROWSER_PROFILE_NAME: "./browser-config.js",
...
function normalizeFacadeSourceParts(sourcePath) {
  const packageSourceMatch = /^@wildvine\/([^/]+)\/([^/]+)$/u.exec(sourcePath);
...
function collectRuntimeApiPreExports(repoRoot, runtimeApiPath) {
  ...
  for (const statement of sourceFile.statements) {
    ...
    if (moduleSpecifier === "wildvine/plugin-sdk/line-runtime") {
      break;
    }
