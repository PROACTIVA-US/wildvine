...
docker run --rm -t \
  ...
  -e WILDVINE_LIVE_MODELS="${WILDVINE_LIVE_MODELS:-${WILDVINE_LIVE_MODELS:-all}}" \
  -e WILDVINE_LIVE_PROVIDERS="${WILDVINE_LIVE_PROVIDERS:-${WILDVINE_LIVE_PROVIDERS:-}}" \
  -e WILDVINE_LIVE_MODEL_TIMEOUT_MS="${WILDVINE_LIVE_MODEL_TIMEOUT_MS:-${WILDVINE_LIVE_MODEL_TIMEOUT_MS:-}}" \
  -e WILDVINE_LIVE_REQUIRE_PROFILE_KEYS="${WILDVINE_LIVE_REQUIRE_PROFILE_KEYS:-${WILDVINE_LIVE_REQUIRE_PROFILE_KEYS:-}}" \
