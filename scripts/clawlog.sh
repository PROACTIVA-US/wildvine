...
show_usage() {
    cat << EOF
clawlog - Wildvine Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Wildvine logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Wildvine logs flow through the macOS unified log (subsystem: com.wildvine).
