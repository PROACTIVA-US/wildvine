...
if [[ -z "$version_content" ]]; then
  echo "<h2>Wildvine $VERSION</h2>"
  echo "<p>Latest Wildvine update.</p>"
  echo "<p><a href=\"https://github.com/PROACTIVA-US/wildvine/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
