...
const DEFAULT_ENTRY = "wildvine.mjs";
...
function printUsage(): void {
  console.log(`Wildvine CLI benchmark
...
Options:
  ...
  --entry <path>               Primary entry file (default: wildvine.mjs)
...
async function main(): Promise<void> {
  ...
  const tmpDir = mkdtempSync(path.join(os.tmpdir(), "wildvine-cli-bench-"));
