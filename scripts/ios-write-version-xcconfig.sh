...
- WILDVINE_GATEWAY_VERSION = exact package.json version
- WILDVINE_MARKETING_VERSION = short iOS/App Store version
- WILDVINE_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
WILDVINE_GATEWAY_VERSION = ${PACKAGE_VERSION}
WILDVINE_MARKETING_VERSION = ${MARKETING_VERSION}
WILDVINE_BUILD_VERSION = ${BUILD_NUMBER}
EOF
