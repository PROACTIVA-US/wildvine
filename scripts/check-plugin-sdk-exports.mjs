...
if (!existsSync(generatedFacadeTypeMapDts)) {
  ...
  if (facadeTypeMapContent.includes("@wildvine/")) {
    console.error(
      "INVALID GENERATED FACADE TYPE MAP DTS: dist/plugin-sdk/src/generated/plugin-sdk-facade-type-map.generated.d.ts leaks @wildvine/* imports",
    );
    missing += 1;
  }
}
