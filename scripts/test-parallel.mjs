...
if (rawCli.showHelp) {
  console.log(
    [
      ...
      "",
      "Runs the planner-backed Wildvine test wrapper.",
      "",
      "Wrapper flags:",
      ...
      "",
      "Environment:",
      "  WILDVINE_TEST_LIST_LANES=1          Print the resolved plan before execution",
      "  WILDVINE_TEST_SHOW_POOL_DECISION=1  Include thread/fork pool decisions in diagnostics",
    ].join("\n"),
  );
  process.exit(0);
}
...
if (process.env.WILDVINE_TEST_LIST_LANES === "1" || rawCli.plan) {
