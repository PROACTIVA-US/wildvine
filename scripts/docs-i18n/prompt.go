...
- Keep product names in English: Wildvine, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Wildvine Gateway, use “Gateway 网关”.
