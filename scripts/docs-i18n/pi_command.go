...
const (
	envDocsPiExecutable     = "WILDVINE_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "WILDVINE_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "WILDVINE_DOCS_I18N_PI_PACKAGE_VERSION"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "wildvine", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
