...
# Output:
# - dist/Wildvine.app
# - dist/Wildvine-<version>.zip
# - dist/Wildvine-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.wildvine.mac}"
...
APP="$ROOT_DIR/dist/Wildvine.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Wildvine-$VERSION.zip"
DMG="$ROOT_DIR/dist/Wildvine-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Wildvine-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Wildvine-$VERSION.dSYM.zip"
