...
export function connectGateway(host: GatewayHost, options?: ConnectGatewayOptions) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "wildvine-control-ui",
    clientVersion,
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void subscribeSessions(host as unknown as WildvineApp);
      void loadAssistantIdentity(host as unknown as WildvineApp);
      void loadAgents(host as unknown as WildvineApp);
      void loadHealthState(host as unknown as WildvineApp);
      void loadNodes(host as unknown as WildvineApp, { quiet: true });
      void loadDevices(host as unknown as WildvineApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (runId && host.refreshSessionsAfterChat.has(runId)) {
    ...
    if (state === "final") {
      void loadSessions(host as unknown as WildvineApp, {
  ...
  if (hadToolEvents && state === "final") {
    void loadChatHistory(host as unknown as WildvineApp);
    return true;
  }
  return false;
}
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as WildvineApp, payload);
