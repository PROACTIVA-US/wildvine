...
declare global {
  interface Window {
    __WILDVINE_ASSISTANT_NAME__?: string;
    __WILDVINE_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__WILDVINE_ASSISTANT_NAME__,
    avatar: window.__WILDVINE_ASSISTANT_AVATAR__,
  });
}
