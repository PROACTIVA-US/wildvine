  ...
  return html`
    <div class="chat-controls">
      <label class="field chat-controls__session">
        <select
          ...
          @change=${(e: Event) => {
            ...
            (state as unknown as WildvineApp).chatStreamStartedAt = null;
            state.chatRunId = null;
            (state as unknown as WildvineApp).resetToolStream();
            (state as unknown as WildvineApp).resetChatScroll();
            state.applySettings({
              ...state.settings,
              sessionKey: next,
      ...
      <button
        ...
        @click=${async () => {
          const app = state as unknown as WildvineApp;
