...
const SKILL_SOURCE_GROUPS: Array<{ id: string; label: string; sources: string[] }> = [
  { id: "workspace", label: "Workspace Skills", sources: ["wildvine-workspace"] },
  { id: "built-in", label: "Built-in Skills", sources: ["wildvine-bundled"] },
  { id: "installed", label: "Installed Skills", sources: ["wildvine-managed"] },
  { id: "extra", label: "Extra Skills", sources: ["wildvine-extra"] },
];
...
function renderSkill(skill: SkillStatusEntry, props: SkillsProps) {
  ...
  const showBundledBadge = Boolean(skill.bundled && skill.source !== "wildvine-bundled");
  const missing = [
