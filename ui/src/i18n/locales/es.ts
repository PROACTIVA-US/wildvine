...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.wildvine/wildvine.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde wildvine dashboard --no-open en tu escritorio.",
    },
    insecure: {
