          ...
          [
            {
              ...
              "extract": true,
              "stripComponents": 1,
              "targetDir": "~/.wildvine/tools/sherpa-onnx-tts/runtime",
            ...
            },
            {
              ...
              "archive": "tar.bz2",
              "extract": true,
              "targetDir": "~/.wildvine/tools/sherpa-onnx-tts/models",
...
1. Download the runtime for your OS (extracts into `~/.wildvine/tools/sherpa-onnx-tts/runtime`)
2. Download a voice model (extracts into `~/.wildvine/tools/sherpa-onnx-tts/models`)

Update `~/.wildvine/wildvine.json`:
