...
export function resolveVitestIsolation(
  ...
  const forceIsolation = env.WILDVINE_TEST_ISOLATE === "1" || env.WILDVINE_TEST_ISOLATE === "true";
  if (forceIsolation) {
    return true;
  }
  return env.WILDVINE_TEST_NO_ISOLATE === "0" || env.WILDVINE_TEST_NO_ISOLATE === "false";
}
