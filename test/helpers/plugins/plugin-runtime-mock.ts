import { DEFAULT_MODEL, DEFAULT_PROVIDER } from "wildvine/plugin-sdk/agent-runtime";
import type { PluginRuntime } from "wildvine/plugin-sdk/testing";
import { removeAckReactionAfterReply, shouldAckReaction } from "wildvine/plugin-sdk/testing";
...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  const base: PluginRuntime = {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/wildvine"),
    },
    modelAuth: {
