...
type LoginOpenAICodexOAuth =
  (typeof import("wildvine/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("wildvine/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
...
type EnsureAuthProfileStore =
  typeof import("wildvine/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("wildvine/plugin-sdk/provider-auth").listProfilesForProvider;
...
vi.mock("wildvine/plugin-sdk/provider-auth-login", async (importOriginal) => {
  const actual = await importOriginal<typeof import("wildvine/plugin-sdk/provider-auth-login")>();
  return {
    ...actual,
...
vi.mock("wildvine/plugin-sdk/provider-auth", async (importOriginal) => {
  const actual = await importOriginal<typeof import("wildvine/plugin-sdk/provider-auth")>();
  return {
    ...actual,
