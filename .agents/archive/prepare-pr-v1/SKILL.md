...
- `fix: <summary> (wildvine#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (wildvine#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "wildvine#$pr_number" || { echo "ERROR: commit subject missing wildvine#$pr_number"; exit 1; }
