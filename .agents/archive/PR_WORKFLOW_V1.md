...
- During `prepare-pr`, use this commit subject format: `fix: <summary> (wildvine#<PR>) thanks @<pr-author>`.
...
- Read `docs/help/submitting-a-pr.md` ([Submitting a PR](https://docs.wildvine.bot/help/submitting-a-pr)) for what we expect from contributors.
