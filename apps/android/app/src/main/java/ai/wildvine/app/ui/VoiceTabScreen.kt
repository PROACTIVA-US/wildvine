...
import com.wildvine.android.voice.VoiceConversationRole
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("Wildvine is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
