    ...
    if (showDiagnostics) {
      Surface(
        ...
        Column(
          ...
          Text("Wildvine Android ${openClawAndroidVersionLabel()}", style = mobileCaption1, color = mobileTextSecondary)
          Button(
            onClick = {
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("wildvine qr --setup-code-only")
          CommandBlock("wildvine qr --json")
