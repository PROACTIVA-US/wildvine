...
enum class WildvineDeviceCommand(val rawValue: String) {
...
enum class WildvineNotificationsCommand(val rawValue: String) {
...
enum class WildvineSystemCommand(val rawValue: String) {
...
enum class WildvinePhotosCommand(val rawValue: String) {
...
enum class WildvineContactsCommand(val rawValue: String) {
...
enum class WildvineCalendarCommand(val rawValue: String) {
...
enum class WildvineMotionCommand(val rawValue: String) {
...
enum class WildvineCallLogCommand(val rawValue: String) {
