...
enum WildvineConfigFile {
    private static let logger = Logger(subsystem: "com.wildvine", category: "config")
    ...
    static func stateDirURL() -> URL {
        WildvinePaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        WildvinePaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-wildvine-config-file",
            "event": "config.write",
