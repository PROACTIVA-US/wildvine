...
enum UIStrings {
    static let welcomeTitle = "Welcome to Wildvine"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "wildvine.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: WildvineOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: WildvineChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g wildvine@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: WildvineChatViewModel(
