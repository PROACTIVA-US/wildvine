...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/PROACTIVA-US/wildvine") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/PROACTIVA-US/wildvine")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://wildvine.com")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "WildvineBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "WildvineBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "WildvineGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "WildvineGitCommit") as? String) ??
            "unknown"
    }
