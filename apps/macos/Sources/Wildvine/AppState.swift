...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = WildvineConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = WildvineConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: WildvineConfigFile.loadDict(),
        ...
        WildvineConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/wildvine"
        state.remoteCliPath = ""
        return state
    }
}
