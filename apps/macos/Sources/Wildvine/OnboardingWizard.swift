...
private let onboardingWizardLogger = Logger(subsystem: "com.wildvine", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between WildvineProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = WildvineProtocol.AnyCodable
