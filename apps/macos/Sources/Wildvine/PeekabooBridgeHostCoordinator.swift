...
final class PeekabooBridgeHostCoordinator {
    ...
    private let logger = Logger(subsystem: "com.wildvine", category: "PeekabooBridge")
    ...
    private static var wildvineSocketPath: String {
        ...
        let directory = base.appendingPathComponent("Wildvine", isDirectory: true)
...
private final class WildvinePeekabooBridgeServices: PeekabooBridgeServiceProviding {
    ...
    init() {
        let logging = LoggingService(subsystem: "com.wildvine.peekaboo")
