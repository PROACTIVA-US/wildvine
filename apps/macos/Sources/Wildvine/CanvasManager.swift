...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "com.wildvine", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Wildvine/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__wildvine__/a2ui/").absoluteString + "?platform=macos"
    }
