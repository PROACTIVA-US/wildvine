...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .wildvineSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? WildvinePaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? WildvinePaths.stateDirURL.path
...
extension Notification.Name {
    static let wildvineSelectSettingsTab = Notification.Name("wildvineSelectSettingsTab")
}
