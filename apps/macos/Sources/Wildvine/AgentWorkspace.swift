...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "com.wildvine", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return WildvineConfigFile.defaultWorkspaceURL() }
