...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "com.wildvine", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".wildvine/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.wildvineCommand(
            subcommand: "gateway",
