...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "com.wildvine", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Wildvine windows, but below the system’s pop-up menus.
