...
actor GatewayEndpointStore {
    ...
    private static let staticLogger = Logger(subsystem: "ai.wildvine", category: "gateway-endpoint")
    ...
    private let logger = Logger(subsystem: "ai.wildvine", category: "gateway-endpoint")
