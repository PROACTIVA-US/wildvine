...
struct WildvineApp: App {
    ...
    private static let logger = Logger(subsystem: "com.wildvine", category: "app")
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let webChatAutoLogger = Logger(subsystem: "com.wildvine", category: "Chat")
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        // Icon handled by macOS via CFBundleIconFile (LSUIElement is false).
