...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "com.wildvine", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "com.wildvine", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [WildvineChatMessage] = messages.compactMap { item in
