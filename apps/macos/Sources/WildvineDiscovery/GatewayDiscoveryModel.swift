...
public final class GatewayDiscoveryModel {
    ...
    private let logger = Logger(subsystem: "ai.wildvine", category: "gateway-discovery")
    ...
    public func start() {
        ...
        for domain in WildvineBonjour.gatewayServiceDomains {
            let browser = GatewayDiscoveryBrowserSupport.makeBrowser(
                serviceType: WildvineBonjour.gatewayServiceType,
                domain: domain,
                queueLabelPrefix: "ai.wildvine.macos.gateway-discovery",
