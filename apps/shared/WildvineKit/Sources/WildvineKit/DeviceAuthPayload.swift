...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: WildvineProtocol.AnyCodable]?
    {
        ...
        return [
            "id": WildvineProtocol.AnyCodable(identity.deviceId),
            "publicKey": WildvineProtocol.AnyCodable(publicKey),
            "signature": WildvineProtocol.AnyCodable(signature),
            "signedAt": WildvineProtocol.AnyCodable(signedAtMs),
            "nonce": WildvineProtocol.AnyCodable(nonce),
        ]
    }
}
