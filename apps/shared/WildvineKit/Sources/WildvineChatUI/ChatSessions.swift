...
public struct WildvineChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct WildvineChatSessionsDefaults: Codable, Sendable {
...
public struct WildvineChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct WildvineChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: WildvineChatSessionsDefaults?
    public let sessions: [WildvineChatSessionEntry]
    ...
    public init(
        ...
        sessions: [WildvineChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
