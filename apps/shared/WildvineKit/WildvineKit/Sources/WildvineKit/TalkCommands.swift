...
public enum WildvineTalkCommand: String, Codable, Sendable {
...
public struct WildvineTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct WildvineTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
