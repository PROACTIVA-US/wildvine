...
public enum WildvineCanvasA2UICommand: String, Codable, Sendable {
...
public struct WildvineCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct WildvineCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
