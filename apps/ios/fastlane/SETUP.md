...
ASC_KEYCHAIN_SERVICE=wildvine-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.wildvine.client
# or
...
- The beta flow regenerates `apps/ios/Wildvine.xcodeproj` from `apps/ios/project.yml` before archiving
