...
struct IOSGatewayChatTransport: WildvineChatTransport, Sendable {
    private static let logger = Logger(subsystem: "ai.wildvine", category: "ios.chat.transport")
        ...
        attachments: [WildvineChatAttachmentPayload]) async throws -> WildvineChatSendResponse
    {
        ...
        do {
            ...
            let decoded = try JSONDecoder().decode(WildvineChatSendResponse.self, from: res)
