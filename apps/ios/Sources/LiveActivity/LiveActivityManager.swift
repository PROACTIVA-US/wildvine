...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.wildvine.ios", category: "LiveActivity")
    private var currentActivity: Activity<WildvineActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = WildvineActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<WildvineActivityAttributes>.activities
    ...
    private func updateCurrent(state: WildvineActivityAttributes.ContentState) {
    ...
    private func connectingState() -> WildvineActivityAttributes.ContentState {
        WildvineActivityAttributes.ContentState(
    ...
    private func idleState() -> WildvineActivityAttributes.ContentState {
        WildvineActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> WildvineActivityAttributes.ContentState {
        WildvineActivityAttributes.ContentState(
