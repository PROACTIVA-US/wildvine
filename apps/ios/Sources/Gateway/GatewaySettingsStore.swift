...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.wildvine.gateway"
    private static let nodeService = "ai.wildvine.node"
    private static let talkService = "ai.wildvine.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.wildvine.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.wildvine.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("wildvine-gateway.log")
    }
