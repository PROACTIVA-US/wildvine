...
enum GatewaySettingsStore {
    private static let gatewayService = "com.wildvine.gateway"
    private static let nodeService = "com.wildvine.node"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "com.wildvine.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "com.wildvine.gateway.diagnostics")
