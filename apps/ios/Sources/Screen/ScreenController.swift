...
final class ScreenController {
    ...
    /// Callback invoked when an wildvine:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = WildvineKitResources.bundle
...
/// Handles navigation policy to intercept wildvine:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept wildvine:// deep links.
        if url.scheme?.lowercased() == "wildvine" {
