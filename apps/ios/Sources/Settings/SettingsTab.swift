...
struct SettingsTab: View {
    ...
    private let gatewayLogger = Logger(subsystem: "com.wildvine.ios", category: "GatewaySettings")
            ...
            Form {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Text("Keeps the screen awake while Wildvine is open.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
    ...
    private var locationMode: WildvineLocationMode {
        WildvineLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
