...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: WildvinePhotosLatestParams) async throws -> WildvinePhotosLatestPayload {
        ...
        var results: [WildvinePhotoPayload] = []
        ...
        return WildvinePhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> WildvinePhotoPayload
    {
