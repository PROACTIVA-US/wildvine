...
import { resolveUserPath } from "wildvine/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "wildvine/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? "2) Reinstall Wildvine (this should install node-llama-cpp): npm i -g wildvine@latest"
      : null,
