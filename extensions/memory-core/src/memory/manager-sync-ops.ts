...
} from "wildvine/plugin-sdk/memory-core-host-engine-embeddings";
import {
...
export abstract class MemoryManagerSyncOps {
  protected abstract readonly cfg: WildvineConfig;
      ...
      try {
        ...
        if (activated) {
          if (
            ...
            process.env.WILDVINE_TEST_MEMORY_UNSAFE_REINDEX === "1"
          ) {
