...
import type { checkQmdBinaryAvailability as checkQmdBinaryAvailabilityFn } from "wildvine/plugin-sdk/memory-core-host-engine-qmd";
...
vi.mock("wildvine/plugin-sdk/memory-core-host-engine-qmd", () => ({
...
function createQmdCfg(agentId: string): WildvineConfig {
  return {
