...
} from "wildvine/plugin-sdk/account-id";
import {
  listCombinedAccountIds,
  resolveListedDefaultAccountId,
} from "wildvine/plugin-sdk/account-resolution";
import { normalizeSecretInputString, type SecretInput } from "wildvine/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: WildvineConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: WildvineConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: WildvineConfig): string {
