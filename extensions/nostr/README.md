...
Nostr DM channel plugin for Wildvine using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Wildvine. It enables your bot to:
...
# Configure wildvine to use local relay
