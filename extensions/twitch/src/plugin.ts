/**
 * Twitch channel plugin for Wildvine.
 *
 ...
 * for Wildvine. Supports message sending, receiving, access control, and
 * status monitoring.
 */
export const twitchPlugin: ChannelPlugin<ResolvedTwitchAccount> =
  createChatChannelPlugin<ResolvedTwitchAccount>({
    ...
    base: {
      ...
      config: {
        listAccountIds: (cfg: WildvineConfig): string[] => listAccountIds(cfg),
        resolveAccount: (cfg: WildvineConfig, accountId?: string | null): ResolvedTwitchAccount => {
        ...
        isConfigured: (_account: unknown, cfg: WildvineConfig): boolean =>
