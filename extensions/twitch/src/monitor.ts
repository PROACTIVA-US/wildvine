...
import type { ReplyPayload, WildvineConfig } from "wildvine/plugin-sdk";
import { createReplyPrefixOptions } from "wildvine/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as WildvineConfig;
