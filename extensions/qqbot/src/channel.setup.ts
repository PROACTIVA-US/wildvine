...
import type { ChannelPlugin } from "wildvine/plugin-sdk/core";
import {
  applyAccountNameToChannelSection,
  deleteAccountFromConfigSection,
  setAccountEnabledInConfigSection,
} from "wildvine/plugin-sdk/core";
import { hasConfiguredSecretInput } from "wildvine/plugin-sdk/secret-input";
import type { ChannelSetupInput } from "wildvine/plugin-sdk/setup";
...
/**
 * Setup-only QQBot plugin — lightweight subset used during `wildvine onboard`
 * and `wildvine configure` without pulling the full runtime dependencies.
 */
