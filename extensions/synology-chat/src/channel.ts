/**
 * Synology Chat Channel Plugin for Wildvine.
 *
 * Implements the ChannelPlugin interface following the LINE pattern.
 */

import type { WildvineConfig } from "wildvine/plugin-sdk/account-resolution";
import {
  createHybridChannelConfigAdapter,
  createScopedDmSecurityResolver,
} from "wildvine/plugin-sdk/channel-config-helpers";
import { waitUntilAbort } from "wildvine/plugin-sdk/channel-lifecycle";
import {
...
import { attachChannelToResult } from "wildvine/plugin-sdk/channel-send-result";
import { createChatChannelPlugin, type ChannelPlugin } from "wildvine/plugin-sdk/core";
import { createEmptyChannelDirectoryAdapter } from "wildvine/plugin-sdk/directory-runtime";
import { DEFAULT_ACCOUNT_ID } from "wildvine/plugin-sdk/setup";
...
const resolveSynologyChatDmPolicy = createScopedDmSecurityResolver<ResolvedSynologyChatAccount>({
  ...
  approveHint: "wildvine pairing approve synology-chat <code>",
...
> & {
  pairing: {
    ...
    notifyApproval: (params: { cfg: WildvineConfig; id: string }) => Promise<void>;
  };
  security: {
    resolveDmPolicy: (params: { cfg: WildvineConfig; account: ResolvedSynologyChatAccount }) => {
  ...
  return createChatChannelPlugin({
    base: {
      ...
      meta: {
        ...
        blurb: "Connect your Synology NAS Chat to Wildvine",
        order: 90,
      },
      capabilities: {
    ...
    pairing: {
      text: {
        ...
        message: "Wildvine: your access has been approved.",
