...
vi.mock("wildvine/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("wildvine/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("wildvine/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("wildvine/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("wildvine/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("wildvine/plugin-sdk/webhook-ingress");
  return {
    ...actual,
