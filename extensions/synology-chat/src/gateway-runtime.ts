import { DEFAULT_ACCOUNT_ID, type WildvineConfig } from "wildvine/plugin-sdk/account-resolution";
import { waitUntilAbort } from "wildvine/plugin-sdk/channel-lifecycle";
import { registerPluginHttpRoute } from "wildvine/plugin-sdk/webhook-ingress";
