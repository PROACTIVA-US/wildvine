...
import { resolveDangerousNameMatchingEnabled } from "wildvine/plugin-sdk/config-runtime";
import type {
...
/** Extract the channel config from the full Wildvine config object. */
function getChannelConfig(cfg: WildvineConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: WildvineConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.WILDVINE_BOT_NAME ?? "Wildvine";
