...
function buildNoImageGenerationModelConfiguredMessage(cfg: WildvineConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: WildvineConfig }) {
