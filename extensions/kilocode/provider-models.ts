import type { KilocodeModelCatalogEntry } from "wildvine/plugin-sdk/provider-model-shared";
import type { ModelDefinitionConfig } from "wildvine/plugin-sdk/provider-model-shared";
