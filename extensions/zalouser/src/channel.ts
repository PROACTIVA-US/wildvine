...
import { createAccountStatusSink } from "wildvine/plugin-sdk/channel-lifecycle";
import { createPairingPrefixStripper } from "wildvine/plugin-sdk/channel-pairing";
import {
  createEmptyChannelResult,
  createRawChannelSendResultAdapter,
} from "wildvine/plugin-sdk/channel-send-result";
import { createStaticReplyToModeResolver } from "wildvine/plugin-sdk/conversation-runtime";
import { createChatChannelPlugin } from "wildvine/plugin-sdk/core";
import { buildPassiveProbedChannelStatusSummary } from "wildvine/plugin-sdk/extension-shared";
import {
...
function resolveZalouserOutboundChunkMode(cfg: WildvineConfig, accountId?: string) {
  return getZalouserRuntime().channel.text.resolveChunkMode(cfg, "zalouser", accountId);
}

function resolveZalouserOutboundTextChunkLimit(cfg: WildvineConfig, accountId?: string) {
