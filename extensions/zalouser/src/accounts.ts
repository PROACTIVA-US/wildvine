...
export function listZalouserAccountIds(cfg: WildvineConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: WildvineConfig): string {
...
function mergeZalouserAccountConfig(cfg: WildvineConfig, accountId: string): ZalouserAccountConfig {
