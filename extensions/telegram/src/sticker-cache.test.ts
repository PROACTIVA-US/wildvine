...
vi.mock("wildvine/plugin-sdk/media-runtime", () => ({
...
const TEST_CACHE_DIR = "/tmp/wildvine-test-sticker-cache/telegram";
...
describe("sticker-cache", () => {
  beforeEach(async () => {
    process.env.WILDVINE_STATE_DIR = "/tmp/wildvine-test-sticker-cache";
    fs.rmSync("/tmp/wildvine-test-sticker-cache", { recursive: true, force: true });
