...
import { resolveApiKeyForProvider } from "wildvine/plugin-sdk/agent-runtime";
import type { ModelCatalogEntry } from "wildvine/plugin-sdk/agent-runtime";
import {
  findModelInCatalog,
  loadModelCatalog,
  modelSupportsVision,
...
import { loadJsonFile, saveJsonFile } from "wildvine/plugin-sdk/json-store";
import { AUTO_IMAGE_KEY_PROVIDERS, DEFAULT_IMAGE_MODELS } from "wildvine/plugin-sdk/media-runtime";
import { resolveAutoImageModel } from "wildvine/plugin-sdk/media-runtime";
import { describeImageFileWithModel } from "wildvine/plugin-sdk/media-understanding-runtime";
import { logVerbose } from "wildvine/plugin-sdk/runtime-env";
import { STATE_DIR } from "wildvine/plugin-sdk/state-paths";
