...
import { getRuntimeConfigSnapshot } from "wildvine/plugin-sdk/runtime-config-snapshot";
import {
  normalizeTelegramCommandName,
  resolveTelegramCustomCommands,
  TELEGRAM_COMMAND_NAME_PATTERN,
} from "wildvine/plugin-sdk/telegram-command-config";
import type {
  ReplyToMode,
...
import {
  ...
  resolveChunkMode,
} from "wildvine/plugin-sdk/reply-dispatch-runtime";
...
import { danger, logVerbose } from "wildvine/plugin-sdk/runtime-env";
...
export const registerTelegramNativeCommands = ({
  ...
  const loadFreshRuntimeConfig = (): WildvineConfig => telegramDeps.loadConfig();
  const resolveFreshTelegramConfig = (runtimeCfg: WildvineConfig): TelegramAccountConfig => {
    try {
