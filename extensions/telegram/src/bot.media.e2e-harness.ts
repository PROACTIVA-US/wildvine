...
import type { GetReplyOptions, MsgContext } from "wildvine/plugin-sdk/reply-runtime";
...
type FetchRemoteMediaFn = typeof import("wildvine/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  loadConfig: (() =>
    ...
    }) as WildvineConfig) as TelegramBotDeps["loadConfig"],
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("wildvine/plugin-sdk/media-runtime")>,
) {
...
vi.mock("wildvine/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("wildvine/plugin-sdk/agent-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("wildvine/plugin-sdk/agent-runtime")>();
  return {
    ...actual,
