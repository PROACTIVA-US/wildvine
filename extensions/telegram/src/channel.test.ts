...
import type { PluginRuntime } from "wildvine/plugin-sdk/testing";
...
function createCfg(): WildvineConfig {
  return {
    channels: {
      telegram: {
        enabled: true,
...
function resolveAccount(cfg: WildvineConfig, accountId: string): ResolvedTelegramAccount {
  return telegramPlugin.config.resolveAccount(cfg, accountId) as ResolvedTelegramAccount;
}

function createStartTelegramContext(cfg: WildvineConfig, accountId: string) {
...
function startTelegramAccount(cfg: WildvineConfig, accountId: string) {
...
function configureOpsProxyNetwork(cfg: WildvineConfig) {
