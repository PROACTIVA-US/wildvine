...
} from "wildvine/plugin-sdk/channel-actions";
...
import type { TelegramActionConfig } from "wildvine/plugin-sdk/config-runtime";
import { extractToolSend } from "wildvine/plugin-sdk/tool-send";
import {
