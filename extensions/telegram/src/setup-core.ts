...
import type { ChannelSetupAdapter, ChannelSetupDmPolicy } from "wildvine/plugin-sdk/setup";
import { formatCliCommand, formatDocsLink } from "wildvine/plugin-sdk/setup-tools";
import type { TelegramNetworkConfig } from "wildvine/plugin-sdk/telegram-core";
...
export const TELEGRAM_TOKEN_HELP_LINES = [
  ...
  "Website: https://wildvine.com",
];

export const TELEGRAM_USER_ID_HELP_LINES = [
  `1) DM your bot, then read from.id in \`${formatCliCommand("wildvine logs --follow")}\` (safest)`,
