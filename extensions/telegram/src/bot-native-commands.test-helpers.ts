...
import type { ChannelGroupPolicy } from "wildvine/plugin-sdk/config-runtime";
import type { TelegramAccountConfig } from "wildvine/plugin-sdk/config-runtime";
import type { RuntimeEnv } from "wildvine/plugin-sdk/runtime-env";
...
type GetPluginCommandSpecsFn =
  typeof import("wildvine/plugin-sdk/plugin-runtime").getPluginCommandSpecs;
type MatchPluginCommandFn = typeof import("wildvine/plugin-sdk/plugin-runtime").matchPluginCommand;
type ExecutePluginCommandFn =
  typeof import("wildvine/plugin-sdk/plugin-runtime").executePluginCommand;
type DispatchReplyWithBufferedBlockDispatcherFn =
  typeof import("wildvine/plugin-sdk/reply-dispatch-runtime").dispatchReplyWithBufferedBlockDispatcher;
type DispatchReplyWithBufferedBlockDispatcherResult = Awaited<
  ReturnType<DispatchReplyWithBufferedBlockDispatcherFn>
>;
type RecordInboundSessionMetaSafeFn =
  typeof import("wildvine/plugin-sdk/conversation-runtime").recordInboundSessionMetaSafe;
...
vi.mock("wildvine/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("wildvine/plugin-sdk/reply-dispatch-runtime", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("wildvine/plugin-sdk/reply-dispatch-runtime")>();
  return {
    ...actual,
...
vi.mock("wildvine/plugin-sdk/conversation-runtime", async (importOriginal) => {
...
vi.mock("wildvine/plugin-sdk/channel-reply-pipeline", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("wildvine/plugin-sdk/channel-reply-pipeline")>();
  return {
    ...actual,
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    loadConfig: vi.fn(() => params?.cfg ?? ({} as WildvineConfig)),
  ...
  registerTelegramNativeCommands({
    bot,
    cfg: params?.cfg ?? ({} as WildvineConfig),
