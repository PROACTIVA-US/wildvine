...
import { isDiagnosticsEnabled } from "wildvine/plugin-sdk/diagnostic-runtime";
import type { RuntimeEnv } from "wildvine/plugin-sdk/runtime-env";
import { defaultRuntime } from "wildvine/plugin-sdk/runtime-env";
...
import { readJsonBodyWithLimit } from "wildvine/plugin-sdk/webhook-request-guards";
...
function resolveTelegramWebhookClientIp(req: IncomingMessage, config?: WildvineConfig): string {
