...
import { resolveAgentMaxConcurrent } from "wildvine/plugin-sdk/config-runtime";
...
import { waitForAbortSignal } from "wildvine/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: WildvineConfig): RunOptions<unknown> {
  return {
    sink: {
