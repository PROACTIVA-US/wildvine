import type { ChannelConfigUiHint } from "wildvine/plugin-sdk/core";
...
export const telegramChannelConfigUiHints = {
  ...
  "execApprovals.approvers": {
    ...
    help: "Telegram user IDs allowed to approve exec requests for this bot account. Use numeric Telegram user IDs. If you leave this unset, Wildvine falls back to numeric owner IDs inferred from channels.telegram.allowFrom and direct-message defaultTo when possible.",
  },
