import { resolveAccountWithDefaultFallback } from "wildvine/plugin-sdk/account-core";
import type { WildvineConfig } from "wildvine/plugin-sdk/config-runtime";
import { coerceSecretRef } from "wildvine/plugin-sdk/config-runtime";
import { tryReadSecretFileSync } from "wildvine/plugin-sdk/core";
import { resolveDefaultSecretProviderAlias } from "wildvine/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "wildvine/plugin-sdk/routing";
import {
  hasConfiguredSecretInput,
  normalizeSecretInputString,
} from "wildvine/plugin-sdk/secret-input";
import type { TelegramAccountConfig } from "wildvine/plugin-sdk/telegram-core";
import {
...
function inspectTokenValue(params: { cfg: WildvineConfig; value: unknown }): {
  token: string;
