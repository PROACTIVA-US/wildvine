import { buildPluginApprovalPendingReplyPayload } from "wildvine/plugin-sdk/approval-runtime";
import type { WildvineConfig } from "wildvine/plugin-sdk/config-runtime";
import {
  createChannelNativeApprovalRuntime,
  resolveExecApprovalRequestAllowedDecisions,
  type ExecApprovalChannelRuntime,
} from "wildvine/plugin-sdk/infra-runtime";
import { resolveExecApprovalCommandDisplay } from "wildvine/plugin-sdk/infra-runtime";
import {
...
function isHandlerConfigured(params: { cfg: WildvineConfig; accountId: string }): boolean {
