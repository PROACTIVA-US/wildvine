...
import { clearHistoryEntriesIfEnabled } from "wildvine/plugin-sdk/reply-history";
import { resolveSendableOutboundReplyParts } from "wildvine/plugin-sdk/reply-payload";
import { resolveChunkMode } from "wildvine/plugin-sdk/reply-runtime";
import type { ReplyPayload } from "wildvine/plugin-sdk/reply-runtime";
import { resolveAutoTopicLabelConfig, generateTopicLabel } from "wildvine/plugin-sdk/reply-runtime";
...
async function resolveStickerVisionSupport(cfg: WildvineConfig, agentId: string) {
  try {
