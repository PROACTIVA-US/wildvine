...
function shouldShowTelegramDmAccessWarning(cfg: WildvineConfig, accountId: string): boolean {
...
function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`wildvine config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`wildvine config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
