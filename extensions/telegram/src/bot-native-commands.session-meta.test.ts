...
import type { ResolvedAgentRoute } from "wildvine/plugin-sdk/routing";
...
type ResolveConfiguredBindingRouteFn =
  typeof import("wildvine/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("wildvine/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
vi.mock("wildvine/plugin-sdk/command-auth", async (importOriginal) => {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  ...
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/wildvine-sessions.json");
