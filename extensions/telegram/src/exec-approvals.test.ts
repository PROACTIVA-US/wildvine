...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<WildvineConfig["channels"]>["telegram"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<WildvineConfig["channels"]>["telegram"]>>,
): WildvineConfig {
  return {
    channels: {
      telegram: {
