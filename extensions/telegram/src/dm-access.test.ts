import type { createChannelPairingChallengeIssuer } from "wildvine/plugin-sdk/channel-pairing";
...
vi.mock("wildvine/plugin-sdk/channel-pairing", () => ({
...
vi.mock("wildvine/plugin-sdk/conversation-runtime", () => ({
