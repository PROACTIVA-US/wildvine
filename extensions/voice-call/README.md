...
Official Voice Call plugin for **Wildvine**.
...
Docs: `https://docs.wildvine.com/plugins/voice-call`
Plugin system: `https://docs.wildvine.com/plugin`

## Install (local dev)

### Option A: install via Wildvine (recommended)
...
```bash
PLUGIN_HOME=~/.wildvine/extensions
mkdir -p "$PLUGIN_HOME"
...
- advanced webhook, streaming, and tunnel notes: `https://docs.wildvine.com/plugins/voice-call`

## Stale call reaper

See the plugin docs for recommended ranges and production examples:
`https://docs.wildvine.com/plugins/voice-call#stale-call-reaper`

## TTS for calls

Voice Call uses the core `messages.tts` configuration for
streaming speech on calls. Override examples and provider caveats live here:
`https://docs.wildvine.com/plugins/voice-call#tts-for-calls`

## CLI

```bash
wildvine voicecall call --to "+15555550123" --message "Hello from Wildvine"
wildvine voicecall continue --call-id <id> --message "Any questions?"
wildvine voicecall speak --call-id <id> --message "One moment"
wildvine voicecall end --call-id <id>
wildvine voicecall status --call-id <id>
wildvine voicecall tail
