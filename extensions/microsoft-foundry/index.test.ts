...
vi.mock("wildvine/plugin-sdk/provider-auth", async () => {
  const actual = await vi.importActual<typeof import("wildvine/plugin-sdk/provider-auth")>(
    "wildvine/plugin-sdk/provider-auth",
  );
  return {
    ...actual,
