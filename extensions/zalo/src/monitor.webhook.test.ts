...
import { createEmptyPluginRegistry } from "wildvine/plugin-sdk/testing";
import { setActivePluginRegistry } from "wildvine/plugin-sdk/testing";
...
function registerTarget(params: {
  ...
  return registerZaloWebhookTarget({
    ...
    config: params.config ?? ({} as WildvineConfig),
    runtime: {},
