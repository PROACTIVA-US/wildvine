...
} from "wildvine/plugin-sdk/allowlist-config-edit";
import { createScopedDmSecurityResolver } from "wildvine/plugin-sdk/channel-config-helpers";
import { createPairingPrefixStripper } from "wildvine/plugin-sdk/channel-pairing";
import { createOpenProviderConfiguredRouteWarningCollector } from "wildvine/plugin-sdk/channel-policy";
import { resolveTargetsWithOptionalToken } from "wildvine/plugin-sdk/channel-targets";
...
} from "wildvine/plugin-sdk/outbound-runtime";
import { normalizeMessageChannel } from "wildvine/plugin-sdk/routing";
import {
    ...
    base: {
      ...
      agentPrompt: {
        messageToolHints: () => [
          ...
          "- Forms: add `components.modal` (title, fields). Wildvine adds a trigger button and routes submissions as new messages.",
        ],
      },
      messaging: {
