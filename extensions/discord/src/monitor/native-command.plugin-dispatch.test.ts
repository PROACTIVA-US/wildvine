...
import type { NativeCommandSpec } from "wildvine/plugin-sdk/command-auth";
import type { WildvineConfig } from "wildvine/plugin-sdk/config-runtime";
import { clearPluginCommands, registerPluginCommand } from "wildvine/plugin-sdk/plugin-runtime";
import { setDefaultChannelPluginRegistryForTests } from "wildvine/plugin-sdk/testing";
...
vi.mock("wildvine/plugin-sdk/plugin-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("wildvine/plugin-sdk/plugin-runtime")>();
  return {
    ...actual,
...
vi.mock("wildvine/plugin-sdk/reply-runtime", async (importOriginal) => {
...
function createConfig(): WildvineConfig {
  return {
    channels: {
      discord: {
...
async function createNativeCommand(cfg: WildvineConfig, commandSpec: NativeCommandSpec) {
...
async function createPluginCommand(params: { cfg: WildvineConfig; name: string }) {
  return createDiscordNativeCommand({
    command: {
      name: params.name,
      description: "Pair",
...
async function createStatusCommand(cfg: WildvineConfig) {
...
describe("Discord native plugin command dispatch", () => {
  ...
  beforeEach(async () => {
    ...
    const actualPluginRuntime = await vi.importActual<
      typeof import("wildvine/plugin-sdk/plugin-runtime")
    >("wildvine/plugin-sdk/plugin-runtime");
    ...
    discordNativeCommandTesting.setMatchPluginCommand(
      runtimeModuleMocks.matchPluginCommand as typeof import("wildvine/plugin-sdk/plugin-runtime").matchPluginCommand,
    );
    discordNativeCommandTesting.setExecutePluginCommand(
      runtimeModuleMocks.executePluginCommand as typeof import("wildvine/plugin-sdk/plugin-runtime").executePluginCommand,
    );
    discordNativeCommandTesting.setDispatchReplyWithDispatcher(
      runtimeModuleMocks.dispatchReplyWithDispatcher as typeof import("wildvine/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher,
    );
