...
import { peekSystemEvents, resetSystemEventsForTest } from "wildvine/plugin-sdk/testing";
...
describe("agent components", () => {
  ...
  const createCfg = (): WildvineConfig => ({}) as WildvineConfig;
  ...
  it("sends pairing reply when DM sender is not allowlisted", async () => {
    ...
    expect(pairingText).toContain(`wildvine pairing approve discord ${code}`);
