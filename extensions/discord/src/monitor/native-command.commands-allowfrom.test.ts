...
import * as pluginCommandsModule from "wildvine/plugin-sdk/plugin-runtime";
...
function createCommand(cfg: WildvineConfig, discordConfig?: DiscordAccountConfig) {
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: WildvineConfig) => void;
