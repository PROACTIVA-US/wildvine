...
import { resolveCommandAuthorizedFromAuthorizers } from "wildvine/plugin-sdk/command-auth-native";
...
import * as conversationRuntime from "wildvine/plugin-sdk/conversation-runtime";
import { resolveAgentRoute } from "wildvine/plugin-sdk/routing";
import { logVerbose } from "wildvine/plugin-sdk/runtime-env";
import * as securityRuntime from "wildvine/plugin-sdk/security-runtime";
import { logError } from "wildvine/plugin-sdk/text-runtime";
import {
...
export type AgentComponentContext = {
  ...
  runtime?: import("wildvine/plugin-sdk/runtime-env").RuntimeEnv;
  token?: string;
