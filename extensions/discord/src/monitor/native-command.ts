...
} from "wildvine/plugin-sdk/command-auth-native";
import {
...
} from "wildvine/plugin-sdk/native-command-registry";
import type { WildvineConfig, loadConfig } from "wildvine/plugin-sdk/config-runtime";
...
import { buildPairingReply } from "wildvine/plugin-sdk/conversation-runtime";
import { getAgentScopedMediaLocalRoots } from "wildvine/plugin-sdk/media-runtime";
import * as pluginRuntime from "wildvine/plugin-sdk/plugin-runtime";
import {
  resolveSendableOutboundReplyParts,
  resolveTextChunksWithFallback,
} from "wildvine/plugin-sdk/reply-payload";
import * as replyRuntime from "wildvine/plugin-sdk/reply-runtime";
...
type DiscordConfig = NonNullable<WildvineConfig["channels"]>["discord"];
