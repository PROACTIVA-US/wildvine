...
import * as commandRegistryModule from "wildvine/plugin-sdk/command-auth";
import type { ChatCommandDefinition, CommandArgsParsing } from "wildvine/plugin-sdk/command-auth";
import type { ModelsProviderData } from "wildvine/plugin-sdk/command-auth";
import type { WildvineConfig } from "wildvine/plugin-sdk/config-runtime";
import * as dispatcherModule from "wildvine/plugin-sdk/reply-runtime";
import * as globalsModule from "wildvine/plugin-sdk/runtime-env";
import * as commandTextModule from "wildvine/plugin-sdk/text-runtime";
...
function createDispatchSpy() {
  ...
  nativeCommandTesting.setDispatchReplyWithDispatcher(
    dispatcherModule.dispatchReplyWithDispatcher as typeof import("wildvine/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher,
  );
  return dispatchSpy;
}
