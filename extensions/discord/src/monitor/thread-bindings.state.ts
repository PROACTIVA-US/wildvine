...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "wildvine/plugin-sdk/routing";
...
const THREAD_BINDINGS_STATE_KEY = Symbol.for("wildvine.discordThreadBindingsState");
