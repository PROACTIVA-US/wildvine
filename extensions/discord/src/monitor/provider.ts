...
import type { WildvineConfig, ReplyToMode } from "wildvine/plugin-sdk/config-runtime";
...
} from "wildvine/plugin-sdk/runtime-group-policy";
import { createConnectedChannelStatusPatch } from "wildvine/plugin-sdk/gateway-runtime";
import { getPluginCommandSpecs } from "wildvine/plugin-sdk/plugin-runtime";
...
import { summarizeStringEntries } from "wildvine/plugin-sdk/text-runtime";
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("wildvine/plugin-sdk/reply-history").HistoryEntry[]
    >();
