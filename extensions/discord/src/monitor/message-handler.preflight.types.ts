...
import type { resolveAgentRoute } from "wildvine/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("wildvine/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("wildvine/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("wildvine/plugin-sdk/config-runtime").WildvineConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
