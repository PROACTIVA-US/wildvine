...
import { buildPluginBindingApprovalCustomId } from "wildvine/plugin-sdk/conversation-runtime";
...
async function createChannelRuntimeMock(
  importOriginal: () => Promise<typeof import("wildvine/plugin-sdk/channel-runtime")>,
) {
...
vi.mock("wildvine/plugin-sdk/channel-runtime", createChannelRuntimeMock);
vi.mock("wildvine/plugin-sdk/channel-runtime.js", createChannelRuntimeMock);
...
describe("discord component interactions", () => {
  ...
  const createCfg = (): WildvineConfig =>
    ({
      channels: {
        discord: {
          replyToMode: "first",
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/wildvine-sessions-test.json");
