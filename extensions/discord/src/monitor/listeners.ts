...
type LoadedConfig = ReturnType<typeof import("wildvine/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("wildvine/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("wildvine/plugin-sdk/runtime-env").createSubsystemLogger>;
