...
import { loadConfig, type WildvineConfig } from "wildvine/plugin-sdk/config-runtime";
import { resolveMarkdownTableMode } from "wildvine/plugin-sdk/config-runtime";
import { maxBytesForKind } from "wildvine/plugin-sdk/media-runtime";
import { extensionForMime } from "wildvine/plugin-sdk/media-runtime";
import { unlinkIfExists } from "wildvine/plugin-sdk/media-runtime";
import type { PollInput } from "wildvine/plugin-sdk/media-runtime";
import { resolveChunkMode } from "wildvine/plugin-sdk/reply-runtime";
import type { RetryConfig } from "wildvine/plugin-sdk/retry-runtime";
...
import { loadWebMediaRaw } from "wildvine/plugin-sdk/web-media";
...
async function materializeVoiceMessageInput(mediaUrl: string): Promise<{ filePath: string }> {
  ...
  const tempDir = resolvePreferredWildvineTmpDir();
