...
import type { DiscordExecApprovalConfig, WildvineConfig } from "wildvine/plugin-sdk/config-runtime";
import type { ExecApprovalRequest, PluginApprovalRequest } from "wildvine/plugin-sdk/infra-runtime";
