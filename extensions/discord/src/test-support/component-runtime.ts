...
async function createConversationRuntimeMock(
  importOriginal: () => Promise<typeof import("wildvine/plugin-sdk/conversation-runtime")>,
) {
...
vi.mock("wildvine/plugin-sdk/security-runtime", (importOriginal) =>
  createAllowFromRuntimeMock(importOriginal),
);

vi.mock("wildvine/plugin-sdk/conversation-runtime", createConversationRuntimeMock);
vi.mock("wildvine/plugin-sdk/conversation-runtime.js", createConversationRuntimeMock);
...
export function resetDiscordComponentRuntimeMocks() {
  ...
  resolvePluginConversationBindingApprovalMock.mockReset().mockResolvedValue({
    ...
    binding: {
      ...
      pluginName: "Wildvine App Server",
