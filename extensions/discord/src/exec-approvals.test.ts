...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<WildvineConfig["channels"]>["discord"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<WildvineConfig["channels"]>["discord"]>>,
): WildvineConfig {
  return {
    channels: {
      discord: {
