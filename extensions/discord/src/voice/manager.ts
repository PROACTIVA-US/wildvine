...
import { resolveAgentDir } from "wildvine/plugin-sdk/agent-runtime";
import { agentCommandFromIngress } from "wildvine/plugin-sdk/agent-runtime";
import { resolveTtsConfig, type ResolvedTtsConfig } from "wildvine/plugin-sdk/agent-runtime";
import type { WildvineConfig } from "wildvine/plugin-sdk/config-runtime";
import type { DiscordAccountConfig, TtsConfig } from "wildvine/plugin-sdk/config-runtime";
import { transcribeAudioFile } from "wildvine/plugin-sdk/media-understanding-runtime";
...
import { parseTtsDirectives } from "wildvine/plugin-sdk/speech";
import { textToSpeech } from "wildvine/plugin-sdk/speech-runtime";
import { formatErrorMessage } from "wildvine/plugin-sdk/ssrf-runtime";
import { resolvePreferredWildvineTmpDir } from "wildvine/plugin-sdk/temp-path";
...
function resolveVoiceTtsConfig(params: { cfg: WildvineConfig; override?: TtsConfig }): {
  cfg: WildvineConfig;
...
async function writeWavFile(pcm: Buffer): Promise<{ path: string; durationSeconds: number }> {
  const tempDir = await fs.mkdtemp(path.join(resolvePreferredWildvineTmpDir(), "discord-voice-"));
