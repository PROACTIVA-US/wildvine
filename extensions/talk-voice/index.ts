import { resolveActiveTalkProviderConfig } from "wildvine/plugin-sdk/config-runtime";
import type { SpeechVoiceOption } from "wildvine/plugin-sdk/speech";
import { definePluginEntry, type WildvinePluginApi } from "./api.js";
