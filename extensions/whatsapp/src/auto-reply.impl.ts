export { HEARTBEAT_PROMPT, stripHeartbeatToken } from "wildvine/plugin-sdk/reply-runtime";
export { HEARTBEAT_TOKEN, SILENT_REPLY_TOKEN } from "wildvine/plugin-sdk/reply-runtime";
