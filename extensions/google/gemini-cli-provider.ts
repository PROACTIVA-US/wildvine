...
import { buildOauthProviderAuthResult } from "wildvine/plugin-sdk/provider-auth-result";
import { fetchGeminiUsage } from "wildvine/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: WildvinePluginApi) {
