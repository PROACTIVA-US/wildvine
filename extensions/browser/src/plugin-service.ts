...
export function createBrowserPluginService(): WildvinePluginService {
  ...
  return {
    ...
    start: async () => {
      ...
      handle = await startLazyPluginServiceModule({
        skipEnvVar: "WILDVINE_SKIP_BROWSER_CONTROL_SERVER",
        overrideEnvVar: "WILDVINE_BROWSER_CONTROL_MODULE",
