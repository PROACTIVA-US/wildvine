...
This directory contains the **BlueBubbles external channel plugin** for Wildvine.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `wildvine/plugin-sdk` helpers.
