...
import { resolveChannelMediaMaxBytes, type WildvineConfig } from "wildvine/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: WildvineConfig; accountId?: string }): string[] {
