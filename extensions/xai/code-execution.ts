...
type XaiPluginConfig = NonNullable<
  NonNullable<WildvineConfig["plugins"]>["entries"]
>["xai"] extends {
  config?: infer Config;
}
  ? Config
...
function readPluginCodeExecutionConfig(cfg?: WildvineConfig): CodeExecutionConfig | undefined {
    ...
    execute: async (_toolCallId: string, args: Record<string, unknown>) => {
      ...
      if (!apiKey) {
        return jsonResult({
          ...
          docs: "https://docs.wildvine.com/tools/code-execution",
        });
      }
