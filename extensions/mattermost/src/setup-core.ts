...
import { createSetupInputPresenceValidator } from "wildvine/plugin-sdk/setup-runtime";
...
export function resolveMattermostAccountWithSecrets(cfg: WildvineConfig, accountId: string) {
