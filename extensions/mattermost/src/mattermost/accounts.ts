import { createAccountListHelpers } from "wildvine/plugin-sdk/account-helpers";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "wildvine/plugin-sdk/account-id";
import { resolveMergedAccountConfig } from "wildvine/plugin-sdk/account-resolution";
...
export function listMattermostAccountIds(cfg: WildvineConfig): string[] {
  return mattermostAccountHelpers.listAccountIds(cfg);
}

export function resolveDefaultMattermostAccountId(cfg: WildvineConfig): string {
...
export function listEnabledMattermostAccounts(cfg: WildvineConfig): ResolvedMattermostAccount[] {
