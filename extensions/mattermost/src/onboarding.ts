import type { ChannelOnboardingAdapter, WildvineConfig, WizardPrompter } from "wildvine/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.wildvine.bot/channels/mattermost",
    ].join("\n"),
