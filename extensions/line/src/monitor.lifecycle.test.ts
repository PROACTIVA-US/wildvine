...
import { WEBHOOK_IN_FLIGHT_DEFAULTS } from "wildvine/plugin-sdk/webhook-request-guards";
...
vi.mock("wildvine/plugin-sdk/reply-runtime", () => ({
...
vi.mock("wildvine/plugin-sdk/channel-reply-pipeline", () => ({
  createChannelReplyPipeline: vi.fn(() => ({})),
}));

vi.mock("wildvine/plugin-sdk/webhook-ingress", () => ({
