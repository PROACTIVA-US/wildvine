import type { ChannelSetupAdapter, WildvineConfig } from "wildvine/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "wildvine/plugin-sdk/setup";
...
export function isLineConfigured(cfg: WildvineConfig, accountId: string): boolean {
