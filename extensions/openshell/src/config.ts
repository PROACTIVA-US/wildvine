...
import { buildPluginConfigSchema, type WildvinePluginConfigSchema } from "wildvine/plugin-sdk/core";
...
export function createOpenShellPluginConfigSchema(): WildvinePluginConfigSchema {
