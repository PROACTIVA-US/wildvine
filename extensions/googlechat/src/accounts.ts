...
export function listGoogleChatAccountIds(cfg: WildvineConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: WildvineConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: WildvineConfig): ResolvedGoogleChatAccount[] {
