import type { ChannelMeta, ChannelPlugin, WildvinebotConfig } from "wildvine/plugin-sdk";
import { DEFAULT_ACCOUNT_ID, PAIRING_APPROVED_MESSAGE } from "wildvine/plugin-sdk";
  ...
  config: {
    ...
    deleteAccount: ({ cfg, accountId }) => {
      ...
      if (isDefault) {
        ...
        const next = { ...cfg } as WildvinebotConfig;
