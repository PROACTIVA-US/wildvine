...
import { addWildcardAllowFrom, DEFAULT_ACCOUNT_ID, formatDocsLink } from "wildvine/plugin-sdk";
...
function setFeishuDmPolicy(cfg: WildvinebotConfig, dmPolicy: DmPolicy): WildvinebotConfig {
  const allowFrom =
    dmPolicy === "open"
...
function setFeishuAllowFrom(cfg: WildvinebotConfig, allowFrom: string[]): WildvinebotConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
