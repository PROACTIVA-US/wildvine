import { createActionGate } from "wildvine/plugin-sdk/agent-runtime";
import type { ChannelMessageActionName } from "wildvine/plugin-sdk/channel-contract";
import type { WildvineConfig } from "wildvine/plugin-sdk/config-runtime";
import type { ChannelToolSend } from "wildvine/plugin-sdk/tool-send";
import { listEnabledSlackAccounts } from "./accounts.js";

export function listSlackMessageActions(cfg: WildvineConfig): ChannelMessageActionName[] {
