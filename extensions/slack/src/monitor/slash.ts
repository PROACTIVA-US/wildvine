...
import { type ChatCommandDefinition, type CommandArgs } from "wildvine/plugin-sdk/command-auth";
import {
...
import { chunkItems } from "wildvine/plugin-sdk/text-runtime";
...
const SLACK_COMMAND_ARG_ACTION_ID = "wildvine_cmdarg";
