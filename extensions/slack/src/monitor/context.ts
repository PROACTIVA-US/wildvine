...
import { resolveSessionKey, type SessionScope } from "wildvine/plugin-sdk/config-runtime";
import type { DmPolicy, GroupPolicy } from "wildvine/plugin-sdk/config-runtime";
import { createDedupeCache } from "wildvine/plugin-sdk/core";
import type { HistoryEntry } from "wildvine/plugin-sdk/reply-history";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("wildvine/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
