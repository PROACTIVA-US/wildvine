import { resolveMarkdownTableMode as resolveMarkdownTableModeImpl } from "wildvine/plugin-sdk/config-runtime";
import {
...
} from "wildvine/plugin-sdk/reply-runtime";
import { resolveAgentRoute as resolveAgentRouteImpl } from "wildvine/plugin-sdk/routing";
import { deliverSlackSlashReplies as deliverSlackSlashRepliesImpl } from "./replies.js";

type ResolveChunkMode = typeof import("wildvine/plugin-sdk/reply-runtime").resolveChunkMode;
type FinalizeInboundContext =
  typeof import("wildvine/plugin-sdk/reply-runtime").finalizeInboundContext;
type DispatchReplyWithDispatcher =
  typeof import("wildvine/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher;
type ResolveConversationLabel =
  typeof import("wildvine/plugin-sdk/conversation-runtime").resolveConversationLabel;
...
type ResolveMarkdownTableMode =
  typeof import("wildvine/plugin-sdk/config-runtime").resolveMarkdownTableMode;
type ResolveAgentRoute = typeof import("wildvine/plugin-sdk/routing").resolveAgentRoute;
