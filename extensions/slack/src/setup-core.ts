...
function enableSlackAccount(cfg: WildvineConfig, accountId: string): WildvineConfig {
...
function hasSlackInteractiveRepliesConfig(cfg: WildvineConfig, accountId: string): boolean {
...
function createSlackTokenCredential(params: {
  ...
  return {
    ...
    applyUseEnv: ({ cfg, accountId }: { cfg: WildvineConfig; accountId: string }) =>
