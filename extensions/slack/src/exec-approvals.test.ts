...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<WildvineConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<WildvineConfig["channels"]>["slack"]>>,
): WildvineConfig {
  return {
    channels: {
      slack: {
