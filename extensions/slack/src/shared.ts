...
import { createChannelPluginBase } from "wildvine/plugin-sdk/core";
import {
  formatDocsLink,
...
import { getChatChannelMeta, type ChannelPlugin, type WildvineConfig } from "./runtime-api.js";

export const SLACK_CHANNEL = "slack" as const;

function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "Wildvine";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for Wildvine`,
    },
    features: {
      bot_user: {
...
export function buildSlackSetupLines(botName = "Wildvine"): string[] {
  return [
