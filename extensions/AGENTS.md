...
- Extension production code should import from `wildvine/plugin-sdk/*` and its
...
- Keep plugin metadata accurate in `wildvine.plugin.json` and the package
  `wildvine` block so discovery and setup work without executing plugin code.
