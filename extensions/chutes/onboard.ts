 ...
 */
export function applyChutesProviderConfig(cfg: WildvineConfig): WildvineConfig {
 ...
 */
export function applyChutesConfig(cfg: WildvineConfig): WildvineConfig {
...
export function applyChutesApiKeyConfig(cfg: WildvineConfig): WildvineConfig {
