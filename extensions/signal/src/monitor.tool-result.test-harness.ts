...
vi.mock("wildvine/plugin-sdk/config-runtime", async () => {
  ...
  return {
    ...actual,
    loadConfig: () => config,
    resolveStorePath: vi.fn(() => "/tmp/wildvine-sessions.json"),
...
vi.mock("wildvine/plugin-sdk/conversation-runtime", async () => {
  const actual = await vi.importActual<typeof import("wildvine/plugin-sdk/conversation-runtime")>(
    "wildvine/plugin-sdk/conversation-runtime",
  );
  return {
    ...actual,
...
vi.mock("wildvine/plugin-sdk/security-runtime", async () => {
  const actual = await vi.importActual<typeof import("wildvine/plugin-sdk/security-runtime")>(
    "wildvine/plugin-sdk/security-runtime",
  );
  return {
    ...actual,
...
vi.mock("wildvine/plugin-sdk/channel-runtime", async () => {
  const actual = await vi.importActual<typeof import("wildvine/plugin-sdk/channel-runtime")>(
    "wildvine/plugin-sdk/channel-runtime",
  );
  return {
    ...actual,
...
export function installSignalToolResultTestHooks() {
  beforeEach(async () => {
    const [{ resetInboundDedupe }, { resetSystemEventsForTest }] = await Promise.all([
      import("wildvine/plugin-sdk/reply-runtime"),
      import("wildvine/plugin-sdk/channel-runtime"),
    ]);
    resetInboundDedupe();
    config = {
