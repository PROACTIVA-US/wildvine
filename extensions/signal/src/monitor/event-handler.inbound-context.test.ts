...
let expectInboundContextContract: typeof import("wildvine/plugin-sdk/testing").expectChannelInboundContextContract;
...
describe("signal createSignalEventHandler inbound context", () => {
  beforeAll(async () => {
    ...
    ({ expectChannelInboundContextContract: expectInboundContextContract } =
      await import("wildvine/plugin-sdk/testing"));
