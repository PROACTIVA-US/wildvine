...
vi.mock("wildvine/plugin-sdk/provider-model-shared", () => ({
...
vi.mock("wildvine/plugin-sdk/json-store", () => ({
  loadJsonFile,
  saveJsonFile,
}));

vi.mock("wildvine/plugin-sdk/state-paths", () => ({
  resolveStateDir: () => "/tmp/wildvine-state",
}));

import type { ProviderResolveDynamicModelContext } from "wildvine/plugin-sdk/core";
...
describe("github-copilot token", () => {
  const cachePath = "/tmp/wildvine-state/credentials/github-copilot.token.json";
