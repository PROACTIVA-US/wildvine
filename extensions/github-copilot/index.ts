import { definePluginEntry, type ProviderAuthContext } from "wildvine/plugin-sdk/plugin-entry";
import {
  coerceSecretRef,
  ensureAuthProfileStore,
  listProfilesForProvider,
} from "wildvine/plugin-sdk/provider-auth";
import { githubCopilotLoginCommand } from "wildvine/plugin-sdk/provider-auth-login";
