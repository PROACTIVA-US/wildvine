...
export function resolveSearxngCategories(config?: WildvineConfig): string | undefined {
  return normalizeTrimmedString(resolveSearxngWebSearchConfig(config)?.categories);
}

export function resolveSearxngLanguage(config?: WildvineConfig): string | undefined {
