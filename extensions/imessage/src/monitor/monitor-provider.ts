...
import { createChannelPairingChallengeIssuer } from "wildvine/plugin-sdk/channel-pairing";
import { createChannelReplyPipeline } from "wildvine/plugin-sdk/channel-reply-pipeline";
import { waitForTransportReady } from "wildvine/plugin-sdk/channel-runtime";
import { loadConfig } from "wildvine/plugin-sdk/config-runtime";
import {
...
import { normalizeScpRemoteHost } from "wildvine/plugin-sdk/host-runtime";
import {
  isInboundPathAllowed,
  resolveIMessageAttachmentRoots,
  resolveIMessageRemoteAttachmentRoots,
} from "wildvine/plugin-sdk/media-runtime";
import { kindFromMime } from "wildvine/plugin-sdk/media-runtime";
import {
  clearHistoryEntriesIfEnabled,
  DEFAULT_GROUP_HISTORY_LIMIT,
  type HistoryEntry,
} from "wildvine/plugin-sdk/reply-history";
import { resolveTextChunkLimit } from "wildvine/plugin-sdk/reply-runtime";
import { dispatchInboundMessage } from "wildvine/plugin-sdk/reply-runtime";
import { createReplyDispatcher } from "wildvine/plugin-sdk/reply-runtime";
import { danger, logVerbose, shouldLogVerbose, warn } from "wildvine/plugin-sdk/runtime-env";
import { resolvePinnedMainDmOwnerFromAllowlist } from "wildvine/plugin-sdk/security-runtime";
 ...
 *   exec ssh -T wildvine@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., wildvine@192.168.64.3)
