...
export const imessageDmPolicy = createTopLevelChannelDmPolicy({
  ...
  getCurrent: (cfg: WildvineConfig) => cfg.channels?.imessage?.dmPolicy ?? "pairing",
  promptAllowFrom: promptIMessageAllowFrom,
});

function resolveIMessageCliPath(params: { cfg: WildvineConfig; accountId: string }) {
...
export const imessageCompletionNote = {
  ...
  lines: [
    ...
    "Ensure Wildvine has Full Disk Access to Messages DB.",
