...
type WebSearchConfig = NonNullable<WildvineConfig["tools"]>["web"] extends infer Web
  ? Web extends { search?: infer Search }
    ? Search
    : undefined
  : undefined;

type WebFetchConfig = NonNullable<WildvineConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: WildvineConfig): WebSearchConfig {
...
function resolveFetchConfig(cfg?: WildvineConfig): WebFetchConfig {
...
export function resolveFirecrawlSearchConfig(cfg?: WildvineConfig): FirecrawlSearchConfig {
...
export function resolveFirecrawlFetchConfig(cfg?: WildvineConfig): FirecrawlFetchConfig {
...
export function resolveFirecrawlApiKey(cfg?: WildvineConfig): string | undefined {
...
export function resolveFirecrawlBaseUrl(cfg?: WildvineConfig): string {
  const search = resolveFirecrawlSearchConfig(cfg);
  const fetch = resolveFirecrawlFetchConfig(cfg);
  const configured =
...
export function resolveFirecrawlOnlyMainContent(cfg?: WildvineConfig, override?: boolean): boolean {
...
export function resolveFirecrawlMaxAgeMs(cfg?: WildvineConfig, override?: number): number {
