 ...
 * middleware with the pattern `/api*`.  When the host application (Wildvine)
 * uses Express 5 — which depends on path-to-regexp v8 — that pattern is
 * invalid and throws:
 *
 *   Missing parameter name at index 5: /api*
 *
 * Wildvine manages its own Express server for the Teams webhook endpoint, so
 ...
 *
 * See: https://github.com/PROACTIVA-US/wildvine/issues/55161
 */
