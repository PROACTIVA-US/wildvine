...
function resolveWildvineVersion(): string {
  try {
 ...
 * and appends the Wildvine version.
 *
 * Format: "teams.ts[apps]/<sdk-version> Wildvine/<wildvine-version>"
 * Example: "teams.ts[apps]/2.0.5 Wildvine/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} Wildvine/${resolveWildvineVersion()}`;
  return cachedUserAgent;
}
