import { describeAccountSnapshot } from "wildvine/plugin-sdk/account-helpers";
import { formatAllowFromLowercase } from "wildvine/plugin-sdk/allow-from";
import { createMessageToolCardSchema } from "wildvine/plugin-sdk/channel-actions";
import { createTopLevelChannelConfigAdapter } from "wildvine/plugin-sdk/channel-config-helpers";
import type {
  ChannelMessageActionAdapter,
  ChannelMessageToolDiscovery,
} from "wildvine/plugin-sdk/channel-contract";
import { createPairingPrefixStripper } from "wildvine/plugin-sdk/channel-pairing";
import {
  createAllowlistProviderGroupPolicyWarningCollector,
  projectConfigWarningCollector,
} from "wildvine/plugin-sdk/channel-policy";
import { createChatChannelPlugin } from "wildvine/plugin-sdk/core";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
  listDirectoryEntriesFromSources,
} from "wildvine/plugin-sdk/directory-runtime";
import { createLazyRuntimeNamedExport } from "wildvine/plugin-sdk/lazy-runtime";
import { createRuntimeOutboundDelegates } from "wildvine/plugin-sdk/outbound-runtime";
import { createComputedAccountStatusAdapter } from "wildvine/plugin-sdk/status-helpers";
import type { ChannelMessageActionName, ChannelPlugin, WildvineConfig } from "../runtime-api.js";
import {
...
const resolveMSTeamsChannelConfig = (cfg: WildvineConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: WildvineConfig }>(
