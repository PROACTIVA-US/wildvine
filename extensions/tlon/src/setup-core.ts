...
export async function resolveTlonSetupConfigured(cfg: WildvineConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: WildvineConfig): Promise<string[]> {
