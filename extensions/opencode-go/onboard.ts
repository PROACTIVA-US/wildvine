...
export function applyOpencodeGoProviderConfig(cfg: WildvineConfig): WildvineConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
...
export function applyOpencodeGoConfig(cfg: WildvineConfig): WildvineConfig {
