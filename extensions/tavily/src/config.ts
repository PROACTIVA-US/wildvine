...
export function resolveTavilySearchConfig(cfg?: WildvineConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: WildvineConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: WildvineConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
